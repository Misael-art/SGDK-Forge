...
description: Use quando a tarefa envolver concepcao, direcao, revisao ou traducao de personagens para Mega Drive. Cobre escala canonica, leitura facial, silhueta, color coding funcional, palette sharing e coerencia de roster. Nao use para timing de animacao isolado ou para cenarios multi-plano.
---
