# Player Logic Flow - Animation Manager Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [ANIMACAO]

This document describes the player control flow and state management for the Animation Manager Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [ANIMACAO].
