# Player Logic Flow - Attack Tutorial Part 2 [VER.001] [SGDK 211] [GEN] [ESTUDO] [COMBATE]

This document describes the player control flow and state management for the Attack Tutorial Part 2 [VER.001] [SGDK 211] [GEN] [ESTUDO] [COMBATE].
