...
// BLAZE_ENGINE e uma base de beat 'em up com dois blocos principais:
// selecao/menus por "room" e gameplay continuo com players, inimigos e camera.
// Para iniciantes, o melhor ponto de entrada e a Room 11, onde o jogo realmente acontece.
...
//--- VARIAVEIS ---//
// Como varios sistemas dividem o mesmo arquivo, as estruturas globais seguram
// estado de camera, HUD, slots de cenario, players, inimigos e objetos interativos.
...
// O main prepara SGDK e usa "room" como um despachante entre creditos,
// menu principal, selecao de personagem e a fase jogavel.
int main(u16 hard) //--- MAIN ---//
{
    ...
    while(TRUE) //MAIN LOOP
    {
		...
		// Cada room representa uma tela ou modo especifico do jogo.
		if(room==8) //CREDITS SCREEN
		{
			...
			if(frames==1)
			{
				PAL_setPalette(PAL0, bgb_credits.palette->data, DMA);
				PAL_setPalette(PAL1, bga_credits.palette->data, DMA);
			}
			if(
			(
		...
		if(room==9) //MAIN SCREEN
		{
			if(frames==0)
			{
				...
				PAL_setPalette(PAL0, bgb_logo.palette->data, DMA);
		...
		if(room==10) //PLAYER SELECT
		{
			...
			if(JOY2_START && qtdePlayers==1)
			{
				...
				PAL_setPalette(PAL3, spr_sel_char04.palette->data, DMA);
			}
					...
					if(atualiza_tela==1)
					{
						...
						if(i==1)
						{
							...
							{ 
								...
								P[i].sprite = SPR_addSprite(&spr_sel_char01,   2,  32, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char01.palette->data, DMA); SPR_setPosition(E[1].sprite,   0,  32); 
							}
							if(P[i].id==2)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_char2_namevoice, sizeof(snd_char2_namevoice)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char02,  82,  32, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char02.palette->data, DMA); SPR_setPosition(E[1].sprite,  80,  32); 
							}
							if(P[i].id==3)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_char3_namevoice, sizeof(snd_char3_namevoice)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char03, 162,  32, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char03.palette->data, DMA); SPR_setPosition(E[1].sprite, 160,  32); 
							}
							if(P[i].id==4)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_char4_namevoice, sizeof(snd_char4_namevoice)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char04, 242,  32, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char04.palette->data, DMA); SPR_setPosition(E[1].sprite, 240,  32); 
							}
							if(P[i].id==5)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char05,   2, 160, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char05.palette->data, DMA); SPR_setPosition(E[1].sprite,   0, 184); 
							}
							if(P[i].id==6)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char06,  66, 160, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char06.palette->data, DMA); SPR_setPosition(E[1].sprite,  64, 184); 
							}
							if(P[i].id==7)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char07, 130, 160, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char07.palette->data, DMA); SPR_setPosition(E[1].sprite, 128, 184); 
							}
							if(P[i].id==8)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char08, 194, 160, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char08.palette->data, DMA); SPR_setPosition(E[1].sprite, 192, 184); 
							}
							if(P[i].id==9)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH3);
								P[i].sprite = SPR_addSprite(&spr_sel_char09, 258, 160, TILE_ATTR(PAL2,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL2, spr_sel_char09.palette->data, DMA); SPR_setPosition(E[1].sprite, 256, 184); 
							}
						}
						if(i==2)
						{
							...
							{ 
								...
								P[i].sprite = SPR_addSprite(&spr_sel_char01,   2,  32, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char01.palette->data, DMA); SPR_setPosition(E[2].sprite,   0+56,  32); 
							}
							if(P[i].id==2)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_char2_namevoice, sizeof(snd_char2_namevoice)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char02,  82,  32, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char02.palette->data, DMA); SPR_setPosition(E[2].sprite,  80+56,  32); 
							}
							if(P[i].id==3)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_char3_namevoice, sizeof(snd_char3_namevoice)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char03, 162,  32, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char03.palette->data, DMA); SPR_setPosition(E[2].sprite, 160+56,  32); 
							}
							if(P[i].id==4)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_char4_namevoice, sizeof(snd_char4_namevoice)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char04, 242,  32, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char04.palette->data, DMA); SPR_setPosition(E[2].sprite, 240+56,  32); 
							}
							if(P[i].id==5)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char05,   2, 160, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char05.palette->data, DMA); SPR_setPosition(E[2].sprite,   0+40, 184); 
							}
							if(P[i].id==6)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char06,  66, 160, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char06.palette->data, DMA); SPR_setPosition(E[2].sprite,  64+40, 184); 
							}
							if(P[i].id==7)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char07, 130, 160, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char07.palette->data, DMA); SPR_setPosition(E[2].sprite, 128+40, 184); 
							}
							if(P[i].id==8)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char08, 194, 160, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char08.palette->data, DMA); SPR_setPosition(E[2].sprite, 192+40, 184); 
							}
							if(P[i].id==9)
							{ 
								//sound, sfx
								XGM_setPCM(INGAME_SFX, snd_cursor, sizeof(snd_cursor)); XGM_startPlayPCM(INGAME_SFX, 1, SOUND_PCM_CH4);
								P[i].sprite = SPR_addSprite(&spr_sel_char09, 258, 160, TILE_ATTR(PAL3,FALSE,FALSE,FALSE) ); PAL_setPalette(PAL3, spr_sel_char09.palette->data, DMA); SPR_setPosition(E[2].sprite, 256+40, 184); 
							}
						}
					}
				}
		...
		// Room 11 e o nucleo do beat 'em up.
		// A ordem abaixo define o frame: fisica, camera, FSM, animacao, sprite position e objetos.
		if(room==11) //IN GAME
		{
			if(frames==0)
			{
				...
				if(faseAtual==1)
				{
					...
					PAL_setPalette(PAL0, map0101.palette->data, DMA);
					gScrollValue+=20;
				}
				if(faseAtual==2)
				{
					...
					PAL_setPalette(PAL0, map0201.palette->data, DMA);
					gScrollValue+=20;
				}
				...
				PAL_setPalette(PAL3, bga_overlayer.palette->data, DMA);
			...
			if(frames==1)
			{
				...
				if(faseAtual==1)
				{
					...
					PAL_setPalette(PAL0, map0102.palette->data, DMA);
					gScrollValue+=20;
				}
				if(faseAtual==2)
				{
					...
					PAL_setPalette(PAL0, map0202.palette->data, DMA);
					gScrollValue+=20;
				}
			...
			if(frames==5) //LOAD P1;P2
			{
				...
				if(SPR_METHOD==2){ point = SPR_addSpriteExSafe(&spr_point, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				...
				PAL_setPalette(PAL2, spr_e01_100.palette->data, DMA);
				//Paleta padrao dos herois (PAL3)
				PAL_setPalette(PAL3, spr_mum_100.palette->data, DMA);
				...
				if( ((E[j].y >= P[i].y-ATTACK_MARGIN) && (E[j].y <= P[i].y+ATTACK_MARGIN)) && E[j].sprite )
				{
					...
					)==1 )
					{
						...
						{ 
							...
							E[j].spark = SPR_addSpriteExSafe(&spr_hit_mum, E[j].sparkX, E[j].sparkY, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
						...
						{ 
							...
							E[j].spark = SPR_addSpriteExSafe(&spr_spark_hit_padrao, E[j].sparkX, E[j].sparkY, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
						...
						{ 
							...
							E[j].sparkY = P[i].y-64-camPosY;
							E[j].spark = SPR_addSpriteExSafe(&spr_hit_blood, E[j].sparkX, E[j].sparkY, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
		...
		if(show_debug==1)
		{
			//PAL_setPaletteColor(15,RGB24_TO_VDPCOLOR(0xff0000));
		...
		if(show_debug==1){ VDP_showFPS(TRUE, 1, 1); }
...
void PLAYER_STATE(u8 Player, u16 State)
{
	...
	if(P[Player].id==1)//MUMMY
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_100, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 112;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_101, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102){
			P[Player].w = 112;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_102, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103){
			P[Player].w = 128;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_103, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104){
			P[Player].w = 112;
			P[Player].h = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_104, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==105){
			P[Player].w = 112;
			P[Player].h = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_105, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 128;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_199, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==202){
			P[Player].w = 112;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_202, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==203){
			P[Player].w = 112;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_203, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==204){
			P[Player].w = 112;
			P[Player].h = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_204, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==205){
			P[Player].w = 112;
			P[Player].h = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_205, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_300, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if( State==301){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_301, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if( State==320){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_320, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==321){
			P[Player].w = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_321, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==322){
			P[Player].w = 152;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_322, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==420){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_420, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==430){
			P[Player].w = 88;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_430, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==431){
			P[Player].w = 136;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_431, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 80;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_501, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 88;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_502, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 72;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_503, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_505, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if( State==506){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 56;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_508, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_510, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_mum_513, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_511, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_mum_514, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_550, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_551, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_552, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 112;
			P[Player].h = 32;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_570, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 56;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_606, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==2)//CAPTAIN COMMANDO
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_100, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 96;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_101, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_102, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103){
			P[Player].w = 88;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_103, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104){
			P[Player].w = 88;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_104, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==105){
			P[Player].w = 120;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_105, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 192;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_199, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==202){
			P[Player].w = 104;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_202, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==203){
			P[Player].w = 80;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_203, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==204){
			P[Player].w = 80;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_204, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==205){
			P[Player].w = 120;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_205, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_300, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==301){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_301, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==320){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_320, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==321){
			P[Player].w = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_321, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==322){
			P[Player].w = 176;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_322, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==420){
			P[Player].w = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_420, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==430){
			P[Player].w = 80;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_430, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==431){
			P[Player].w = 120;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_431, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 72;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_501, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 64;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_502, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 56;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_503, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_505, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 56;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_508, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_510, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_cap_513, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_511, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_cap_514, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_550, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_551, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_552, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 96;
			P[Player].h = 32;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_570, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 48;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_cap_606, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==3)//NINJA
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_100, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 104;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_101, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102){
			P[Player].w = 112;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_102, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103){
			P[Player].w = 112;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_103, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104){
			P[Player].w = 96;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_104, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 176;
			P[Player].h = 136;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_199, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==202){
			P[Player].w = 112;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_202, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==203){
			P[Player].w = 96;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_203, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==204){
			P[Player].w = 120;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_204, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==205 || State==105){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_205, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_300, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==301){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_301, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==320){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_320, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==321){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_321, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==322){
			P[Player].w = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_322, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==420){
			P[Player].w = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_420, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==430){
			P[Player].w = 72;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_430, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==431){
			P[Player].w = 128;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_431, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 56;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_501, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_502, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 56;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_503, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_505, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 56;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_508, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_510, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_nin_513, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_511, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_nin_514, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_550, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_551, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 112;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_552, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 88;
			P[Player].h = 24;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_570, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}		
		if( State==606){
			P[Player].w = 40;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_nin_606, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==4)//BABY
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_100, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 112;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_101, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_102, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_103, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104){
			P[Player].w = 144;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_104, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==105){
			P[Player].w = 144;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_105, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 160;
			P[Player].h = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_199, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==202){
			P[Player].w = 120;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_202, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==203){
			P[Player].w = 104;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_203, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==204){
			P[Player].w = 144;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_204, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==205){
			P[Player].w = 120;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_205, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_300, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==301){
			P[Player].w = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_301, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==320){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_320, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[1].y+1); }
		}
		if( State==321){
			P[Player].w = 136;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_321, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==322){
			P[Player].w = 112;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_322, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[1].sprite){ SPR_setDepth(P[1].sprite, 257-P[Player].ground+1); }
		}
		if( State==420){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_420, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==430){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_430, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==431){
			P[Player].w = 120;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_431, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 96;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_501, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_502, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 80;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_503, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_505, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 56;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_508, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_509, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				//P[Player].partB = SPR_addSpriteExSafe(&spr_bab_513, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_509, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				//P[Player].partB = SPR_addSpriteExSafe(&spr_bab_514, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_550, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_551, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_552, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 112;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_570, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 72;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_bab_606, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==5)//ENEMY01
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102 || State==202){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_102, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103 || State==203){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_103, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 64;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==301 || State==321 || State==322){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if( State==420 || State==430){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 72;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e01_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e01_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 112;
			P[Player].h = 32;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 72;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e01_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==6)//ENEMY02
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102 || State==202){
			P[Player].w = 104;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_102, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103 || State==203){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_103, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			P[Player].w = 88;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 64;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==301 || State==321 || State==322){
			P[Player].w = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].ground+1); }
		}
		if( State==420 || State==430){
			P[Player].w = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 72;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e02_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e02_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 112;
			P[Player].h = 32;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 48;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e02_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==7)//ENEMY03
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102 || State==202){
			P[Player].w = 104;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_102, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103 || State==203){
			P[Player].w = 88;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_103, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			P[Player].w = 88;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 80;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==301 || State==321 || State==322){
			P[Player].w = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].ground+1); }
		}
		if( State==420 || State==430){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 64;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 72;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e03_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e03_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 112;
			P[Player].h = 32;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 48;
			P[Player].h = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e03_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==8)//ENEMY04
	{
		...
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101 || State==102 || State==202 || State==103 || State==203 ){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			P[Player].w = 136;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 120;
			P[Player].h = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==301 || State==321 || State==322){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].ground+1); }
		}
		if( State==420 || State==430){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 72;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 80;
			P[Player].h = 64;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 72;
			P[Player].h = 80;
		...
		if( State==505){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 72;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e04_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_511, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e04_514, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 104;
			P[Player].h = 16;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			P[Player].w = 72;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e04_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==9)//ENEMY05
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101 || State==102 || State==202 || State==103 || State==203 || State==104 || State==204 || State==105 || State==205 || State==431){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			P[Player].w = 104;
			P[Player].h = 80;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==301 || State==321 || State==322){
			P[Player].w = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].ground+1); }
		}
		if( State==320){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_320, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==420){
			P[Player].w = 72;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==430){
			P[Player].w = 96;
			P[Player].h = 128;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_430, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			P[Player].w = 80;
			P[Player].h = 112;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			P[Player].w = 88;
			P[Player].h = 96;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			P[Player].w = 80;
			P[Player].h = 104;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==506){
			P[Player].w = 88;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			P[Player].w = 96;
			P[Player].h = 48;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			P[Player].w = 144;
			P[Player].h = 40;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			P[Player].ground = P[Player].y;
			P[Player].y--;
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e05_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				P[Player].partB = SPR_addSpriteExSafe(&spr_e05_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(P[Player].direction==-1)
			{
				SPR_setHFlip(P[Player].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==551){
			P[Player].ground = P[Player].y;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(P[Player].sprite){ SPR_setDepth(P[Player].sprite, 257-P[Player].y+1); }
		}
		if( State==552){
			P[Player].w = 128;
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			P[Player].w = 144;
			P[Player].h = 40;
		...
		if( State==606){
			...
			if(SPR_METHOD==2){ P[Player].sprite = SPR_addSpriteExSafe(&spr_e05_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(P[Player].id==0)
	{
		if(State==100){
			...
			P[Player].dataAnim[1]  = 250;
			P[Player].animFrameTotal = 1;
			P[Player].sprite = SPR_addSpriteExSafe(&spr_point, 512, 256, TILE_ATTR(P[Player].paleta, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
		}
	}
	...
	if(P[Player].id==1)
	{
		if(State==100){
			...
			P[Player].dataAnim[4]  = 6;
			P[Player].animFrameTotal = 4;
			P[Player].sprite = SPR_addSpriteExSafe(&spr_mum_100, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
		}
		if(State==101){
			P[Player].w = 13*8;
			P[Player].h = 13*8;
			...
			P[Player].dataAnim[3]  = 2;
			P[Player].animFrameTotal = 3;
			P[Player].sprite = SPR_addSpriteExSafe(&spr_geese_101, P[Player].x-P[Player].axisX, P[Player].y-P[Player].axisY, TILE_ATTR(P[Player].paleta, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
		}
	}
...
void ENEMY_STATE(u8 Enemy, u16 State)
{
	...
	if(E[Enemy].id==5)//ENEMY01
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			E[Enemy].w = 88;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102 || State==202){
			E[Enemy].w = 104;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_102, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103 || State==203){
			E[Enemy].w = 88;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_103, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			E[Enemy].w = 88;
			E[Enemy].h = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			E[Enemy].w = 64;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if( State==301 || State==321 || State==322){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if( State==420 || State==430){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==506){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			E[Enemy].w = 96;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			E[Enemy].w = 72;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e01_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e01_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==551){
			E[Enemy].ground = E[Enemy].y;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==552){
			E[Enemy].w = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			E[Enemy].w = 112;
			E[Enemy].h = 32;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			E[Enemy].w = 72;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==700){
			E[Enemy].w = 64;
			E[Enemy].h = 48;
		...
		if( State==701){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e01_198, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(E[Enemy].id==6)//ENEMY02
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			E[Enemy].w = 88;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102 || State==202){
			E[Enemy].w = 104;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_102, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103 || State==203){
			E[Enemy].w = 88;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_103, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			E[Enemy].w = 88;
			E[Enemy].h = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			E[Enemy].w = 64;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==301 || State==321 || State==322){
			E[Enemy].w = 104;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].ground+1); }
		}
		if( State==420 || State==430){
			E[Enemy].w = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==506){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			E[Enemy].w = 96;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			E[Enemy].w = 72;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e02_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e02_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==551){
			E[Enemy].ground = E[Enemy].y;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==552){
			E[Enemy].w = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			E[Enemy].w = 112;
			E[Enemy].h = 32;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			E[Enemy].w = 48;
			E[Enemy].h = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==700){
			E[Enemy].w = 64;
			E[Enemy].h = 48;
		...
		if( State==701){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e02_198, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(E[Enemy].id==7)//ENEMY03
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101){
			E[Enemy].w = 88;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==102 || State==202){
			E[Enemy].w = 104;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_102, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==103 || State==203){
			E[Enemy].w = 88;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_103, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			E[Enemy].w = 88;
			E[Enemy].h = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			E[Enemy].w = 80;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==301 || State==321 || State==322){
			E[Enemy].w = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].ground+1); }
		}
		if( State==420 || State==430){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			E[Enemy].w = 64;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==506){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			E[Enemy].w = 96;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			E[Enemy].w = 72;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e03_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e03_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==551){
			E[Enemy].ground = E[Enemy].y;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==552){
			E[Enemy].w = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			E[Enemy].w = 112;
			E[Enemy].h = 32;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			E[Enemy].w = 48;
			E[Enemy].h = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e03_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(E[Enemy].id==8)//ENEMY04
	{
		...
		if( State==100){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101 || State==102 || State==202 || State==103 || State==203 ){
			E[Enemy].w = 136;
			E[Enemy].h = 104;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==104 || State==204 || State==105 || State==205 || State==431 ){
			E[Enemy].w = 136;
			E[Enemy].h = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_104, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			E[Enemy].w = 120;
			E[Enemy].h = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300 || State==320){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==301 || State==321 || State==322){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].ground+1); }
		}
		if( State==420 || State==430){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			E[Enemy].w = 72;
			E[Enemy].h = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			E[Enemy].w = 80;
			E[Enemy].h = 64;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			E[Enemy].w = 72;
			E[Enemy].h = 80;
		...
		if( State==505){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==506){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			E[Enemy].w = 96;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			E[Enemy].w = 72;
			E[Enemy].h = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_508, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e04_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_511, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e04_514, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==551){
			E[Enemy].ground = E[Enemy].y;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==552){
			E[Enemy].w = 96;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			E[Enemy].w = 104;
			E[Enemy].h = 16;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==606){
			E[Enemy].w = 72;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e04_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
	...
	if(E[Enemy].id==9)//ENEMY05
	{
		if( State==100){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_100, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==101 || State==102 || State==202 || State==103 || State==203 || State==104 || State==204 || State==105 || State==205 || State==431){
			E[Enemy].w = 144;
			E[Enemy].h = 112;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_101, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==199){
			E[Enemy].w = 104;
			E[Enemy].h = 80;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_199, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==300){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_300, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==301 || State==321 || State==322){
			E[Enemy].w = 104;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_301, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].ground+1); }
		}
		if( State==320){
			E[Enemy].ground = E[Enemy].y;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_320, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==420){
			E[Enemy].w = 72;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_420, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==430){
			E[Enemy].w = 96;
			E[Enemy].h = 128;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_430, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==501){
			E[Enemy].w = 80;
			E[Enemy].h = 112;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_501, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==502){
			E[Enemy].w = 88;
			E[Enemy].h = 96;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_502, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==503){
			E[Enemy].w = 80;
			E[Enemy].h = 104;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_503, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==505){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_505, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==506){
			E[Enemy].w = 88;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_506, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==507){
			E[Enemy].w = 96;
			E[Enemy].h = 48;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_507, 512, 256, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==508){
			E[Enemy].w = 144;
			E[Enemy].h = 40;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_570, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==509){
			E[Enemy].ground = E[Enemy].y;
			E[Enemy].y--;
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_509, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e05_512, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==510){
			...
			if(SPR_METHOD==2){ 
				E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_510, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
				E[Enemy].partB = SPR_addSpriteExSafe(&spr_e05_513, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); 
			}
			if(E[Enemy].direction==-1)
			{
				SPR_setHFlip(E[Enemy].sprite, 1);
		...
		if( State==550){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_550, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==551){
			E[Enemy].ground = E[Enemy].y;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_551, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
			if(E[Enemy].sprite){ SPR_setDepth(E[Enemy].sprite, 257-E[Enemy].y+1); }
		}
		if( State==552){
			E[Enemy].w = 128;
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_552, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
		if( State==570){
			E[Enemy].w = 144;
			E[Enemy].h = 40;
		...
		if( State==606){
			...
			if(SPR_METHOD==2){ E[Enemy].sprite = SPR_addSpriteExSafe(&spr_e05_606, 512, 256, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		}
	}
...
void CREATE_ENEMY(u8 ID, u16 State, s16 pX, s16 pY)
{
	...
	if(E[qtdeInimigos].id==5){ PAL_setPalette(PAL2, spr_e01_100.palette->data, DMA); }
	if(E[qtdeInimigos].id==6){ PAL_setPalette(PAL2, spr_e02_100.palette->data, DMA); }
	if(E[qtdeInimigos].id==7){ PAL_setPalette(PAL2, spr_e03_100.palette->data, DMA); }
	if(E[qtdeInimigos].id==8){ PAL_setPalette(PAL2, spr_e04_100.palette->data, DMA); }
	if(E[qtdeInimigos].id==9){ PAL_setPalette(PAL2, spr_e05_100.palette->data, DMA); }
	...
	if(updateSlot!=0)
	{
		if(updateSlot==1 && faseAtual==1)
		{
			...
			if(segmentInFocus==1)
			{
				...
				PAL_setPalette(PAL1, map0103.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==2)
			{
				...
				PAL_setPalette(PAL1, map0104.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==3)
			{
				...
				PAL_setPalette(PAL0, map0105.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==4)
			{
				...
				PAL_setPalette(PAL0, map0106.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==5)
			{
				...
				PAL_setPalette(PAL1, map0107.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==6)
			{
				...
				PAL_setPalette(PAL1, map0108.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==7)
			{
				...
				PAL_setPalette(PAL0, map0109.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==8)
			{
				...
				PAL_setPalette(PAL0, map0110.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==9)
			{
				...
				PAL_setPalette(PAL1, map0111.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==10)
			{
				...
				PAL_setPalette(PAL1, map0112.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==11)
			{
				...
				PAL_setPalette(PAL0, map0113.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==12)
			{
				...
				PAL_setPalette(PAL0, map0114.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==13)
			{
				...
				PAL_setPalette(PAL1, map0115.palette->data, DMA);
				gScrollValue+=20;
			}
			...
			if(segmentInFocus==14)
			{
				...
				PAL_setPalette(PAL1, map0116.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==15)
			{
				...
				PAL_setPalette(PAL0, map0117.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==16)
			{
				...
				PAL_setPalette(PAL0, map0118.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==17)
			{
				...
				PAL_setPalette(PAL1, map0119.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==18)
			{
				...
				PAL_setPalette(PAL1, map0120.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==19)
			{
				...
				PAL_setPalette(PAL0, map0121.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==20)
			{
				...
				PAL_setPalette(PAL0, map0122.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==21)
			{
				...
				PAL_setPalette(PAL1, map0123.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==22)
			{
				...
				PAL_setPalette(PAL1, map0124.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==23)
			{
				...
				PAL_setPalette(PAL0, map0125.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==24)
			{
				...
				PAL_setPalette(PAL0, map0126.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==25)
			{
				...
				PAL_setPalette(PAL1, map0127.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==26)
			{
				...
				PAL_setPalette(PAL1, map0128.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==27)
			{
				...
				PAL_setPalette(PAL0, map0129.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==28)
			{
				...
				PAL_setPalette(PAL0, map0130.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==29)
			{
				...
				PAL_setPalette(PAL1, map0131.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==30)
			{
				...
				PAL_setPalette(PAL1, map0132.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==31)
			{
				...
				PAL_setPalette(PAL0, map0133.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==32)
			{
				...
				PAL_setPalette(PAL0, map0134.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==33)
			{
				...
				PAL_setPalette(PAL1, map0135.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==34)
			{
				...
				PAL_setPalette(PAL1, map0136.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==35)
			{
				...
				PAL_setPalette(PAL0, map0137.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==36)
			{
				...
				PAL_setPalette(PAL0, map0138.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==37)
			{
				...
				PAL_setPalette(PAL1, map0139.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==38)
			{
				...
				PAL_setPalette(PAL1, map0140.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==39)
			{
				...
				PAL_setPalette(PAL0, map0141.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==40)
			{
				...
				PAL_setPalette(PAL0, map0142.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==41)
			{
				...
				PAL_setPalette(PAL1, map0143.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==42)
			{
				...
				PAL_setPalette(PAL1, map0144.palette->data, DMA);
				gScrollValue+=20;
			}
			*/
			//---
		...
		if(updateSlot==1 && faseAtual==2)
		{
			...
			if(segmentInFocus==1)
			{
				...
				PAL_setPalette(PAL1, map0203.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==2)
			{
				...
				PAL_setPalette(PAL1, map0204.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==3)
			{
				...
				PAL_setPalette(PAL0, map0205.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==4)
			{
				...
				PAL_setPalette(PAL0, map0206.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==5)
			{
				...
				PAL_setPalette(PAL1, map0207.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==6)
			{
				...
				PAL_setPalette(PAL1, map0208.palette->data, DMA);
				gScrollValue+=20;
			}
			if(segmentInFocus==7)
			{
