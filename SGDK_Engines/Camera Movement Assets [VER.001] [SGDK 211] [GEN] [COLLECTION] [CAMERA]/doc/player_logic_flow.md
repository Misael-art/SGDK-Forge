# Player Logic Flow - Camera Movement Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [CAMERA]

This document describes the player control flow and state management for the Camera Movement Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [CAMERA].
