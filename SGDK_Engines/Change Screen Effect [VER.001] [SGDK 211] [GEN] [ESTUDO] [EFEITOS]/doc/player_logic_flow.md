# Player Logic Flow - Change Screen Effect [VER.001] [SGDK 211] [GEN] [ESTUDO] [EFEITOS]

This document describes the player control flow and state management for the Change Screen Effect [VER.001] [SGDK 211] [GEN] [ESTUDO] [EFEITOS].
