# Engine Architecture Nodes - Custom Font [VER.001] [SGDK 211] [GEN] [ESTUDO] [TEXTO]

Overview of the technical structure of the Custom Font [VER.001] [SGDK 211] [GEN] [ESTUDO] [TEXTO] engine.
...
while, main, if, drawText, initFont, for, showMessage, drawCharacter, getCharacterTile
