# Player Logic Flow - Custom Fonts Example [VER.001] [SGDK 211] [GEN] [ESTUDO] [TEXTO]

This document describes the player control flow and state management for the Custom Fonts Example [VER.001] [SGDK 211] [GEN] [ESTUDO] [TEXTO].
...
The project uses active input handlers: handleJoyEvent
