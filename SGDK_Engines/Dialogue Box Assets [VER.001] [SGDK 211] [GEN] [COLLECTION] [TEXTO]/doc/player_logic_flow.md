# Player Logic Flow - Dialogue Box Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [TEXTO]

This document describes the player control flow and state management for the Dialogue Box Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [TEXTO].
