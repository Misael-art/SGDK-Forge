# Engine Architecture Nodes - Example Platformer [VER.001] [SGDK 211] [GEN] [TEMPLATE] [PLATAFORMA]

Overview of the technical structure of the Example Platformer [VER.001] [SGDK 211] [GEN] [TEMPLATE] [PLATAFORMA] engine.
...
readInput, while, inputHandler, if, main, updatePhysics
