# Player Logic Flow - Example Platformer [VER.001] [SGDK 211] [GEN] [TEMPLATE] [PLATAFORMA]

This document describes the player control flow and state management for the Example Platformer [VER.001] [SGDK 211] [GEN] [TEMPLATE] [PLATAFORMA].
...
The project uses active input handlers: inputHandler
