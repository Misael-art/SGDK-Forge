# Engine Architecture Nodes - FMV Code Sample [VER.001] [SGDK 211] [GEN] [ESTUDO] [VIDEO]

Overview of the technical structure of the FMV Code Sample [VER.001] [SGDK 211] [GEN] [ESTUDO] [VIDEO] engine.
...
joyEvent, vint, while, if, doSync, nextFrame, processMap, main, hint
