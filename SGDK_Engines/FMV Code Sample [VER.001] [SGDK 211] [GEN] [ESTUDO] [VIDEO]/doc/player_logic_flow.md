# Player Logic Flow - FMV Code Sample [VER.001] [SGDK 211] [GEN] [ESTUDO] [VIDEO]

This document describes the player control flow and state management for the FMV Code Sample [VER.001] [SGDK 211] [GEN] [ESTUDO] [VIDEO].
