...
extern const u8 WAV_FireballFire[9472];
extern const u8 WAV_Boing[15104];
extern const u8 WAV_Oof[6656];
extern const u8 WAV_Ouch[7168];
extern const u8 WAV_Ding[42496];
