# Engine Architecture Nodes - Gargoyle Collision Test [VER.001] [SGDK 211] [GEN] [ESTUDO] [COLISAO]

Overview of the technical structure of the Gargoyle Collision Test [VER.001] [SGDK 211] [GEN] [ESTUDO] [COLISAO] engine.
...
getPlayerTile, movementAndCollision, while, updateCameraPosition, textDisplay, handleInput, if, setCameraPosition, setSpritePosition, main
