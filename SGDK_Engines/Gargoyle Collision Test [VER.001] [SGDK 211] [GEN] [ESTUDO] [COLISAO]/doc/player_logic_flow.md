# Player Logic Flow - Gargoyle Collision Test [VER.001] [SGDK 211] [GEN] [ESTUDO] [COLISAO]

This document describes the player control flow and state management for the Gargoyle Collision Test [VER.001] [SGDK 211] [GEN] [ESTUDO] [COLISAO].
