# Player Logic Flow - Goblin SGDK [VER.001] [SGDK 211] [GEN] [GAME] [AVENTURA]

This document describes the player control flow and state management for the Goblin SGDK [VER.001] [SGDK 211] [GEN] [GAME] [AVENTURA].
