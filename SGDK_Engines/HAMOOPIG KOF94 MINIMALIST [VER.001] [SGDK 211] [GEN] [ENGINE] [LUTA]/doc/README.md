# Documentacao de KOF94 HAMOOPIG MINIMALIST [VER.001] [SGDK 211] [GEN] [ENGINE] [LUTA]
...
7. `07-material-de-referencia.md`
...
- Material visual de apoio fica em `doc/assets/`
- Material historico e notas herdadas ficam em `doc/reference/`
