    ...
    while(TRUE) /// LOOP PRINCIPAL ///
    {
		...
		if(gRoom==2) //TELA DE APRESENTACAO -------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				GE[10].sprite = SPR_addSpriteExSafe(&spr_petala_big,  70, 180, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				//SPR_setVRAMTileIndex(GE[10].sprite, 1521); //define uma posicao especifica para o GFX na VRAM
				
				GE[11].sprite = SPR_addSpriteExSafe(&spr_petala_big,  170, 10, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[11].sprite, 0, 1);
				GE[12].sprite = SPR_addSpriteExSafe(&spr_petala_big,  150, 30, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[12].sprite, 0, 3);
				GE[13].sprite = SPR_addSpriteExSafe(&spr_petala_big,  180, 50, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[13].sprite, 0, 5);
				GE[14].sprite = SPR_addSpriteExSafe(&spr_petala_big,  200, 70, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[14].sprite, 0, 7);
				GE[15].sprite = SPR_addSpriteExSafe(&spr_petala_big,  230, 90, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[15].sprite, 0, 9);
				
				GE[16].sprite = SPR_addSpriteExSafe(&spr_petala_big,  20, 20, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				...
				GE[17].sprite = SPR_addSpriteExSafe(&spr_petala_big,  270, 110, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[17].sprite, 0, 1);
				GE[18].sprite = SPR_addSpriteExSafe(&spr_petala_big,  250, 130, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[18].sprite, 0, 3);
				GE[19].sprite = SPR_addSpriteExSafe(&spr_petala_big,  280, 200, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[19].sprite, 0, 5);
				GE[20].sprite = SPR_addSpriteExSafe(&spr_petala_big,  240, 15, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
				SPR_setAnimAndFrame(GE[20].sprite, 0, 7);
				GE[21].sprite = SPR_addSpriteExSafe(&spr_petala_big,  300, 180, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), 1, SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_SPRITE_ALLOC);
	...
	*/
	...
	{ 
		...
		if(P[1].id==1) //haohmaru
		{
			if(P[1].rageLvl==0)
			{
				if(P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_1a.palette ->data); } 
				if(P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_1a.palette ->data); } 
				if(P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_1a.palette ->data); } 
				if(P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_1a.palette ->data); } 
				if(P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_1a.palette ->data); } 
				if(P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_1a.palette ->data); } 
				if(P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_1a.palette ->data); } 
				if(P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_1a.palette ->data); } 
			}
			if(P[1].rageLvl==1)
			{
				if(P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_2a.palette ->data); } 
				if(P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_2a.palette ->data); } 
				if(P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_2a.palette ->data); } 
				if(P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_2a.palette ->data); } 
				if(P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_2a.palette ->data); } 
				if(P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_2a.palette ->data); } 
				if(P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_2a.palette ->data); } 
				if(P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_2a.palette ->data); } 
			}
			if(P[1].rageLvl==2)
			{
				if(P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_3a.palette ->data); } 
				if(P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_3a.palette ->data); } 
				if(P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_3a.palette ->data); } 
				if(P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_3a.palette ->data); } 
				if(P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_3a.palette ->data); } 
				if(P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_3a.palette ->data); } 
				if(P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_3a.palette ->data); } 
				if(P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_3a.palette ->data); } 
			}
		}
		...
		if(P[2].id==1) //haohmaru
		{
			if(P[2].rageLvl==0)
			{
				if(P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_1a.palette ->data); }
				if(P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_1a.palette ->data); }
				if(P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_1a.palette ->data); }
				if(P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_1a.palette ->data); }
				if(P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_1a.palette ->data); }
				if(P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_1a.palette ->data); }
				if(P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_1a.palette ->data); }
				if(P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_1a.palette ->data); } 
			}
			//P2
			if(P[2].rageLvl==1)
			{
				if(P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_2a.palette ->data); }
				if(P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_2a.palette ->data); }
				if(P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_2a.palette ->data); }
				if(P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_2a.palette ->data); }
				if(P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_2a.palette ->data); }
				if(P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_2a.palette ->data); }
				if(P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_2a.palette ->data); }
				if(P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_2a.palette ->data); } 
			}
			//P2
			if(P[2].rageLvl==2)
			{
				if(P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_3a.palette ->data); }
				if(P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_3a.palette ->data); }
				if(P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_3a.palette ->data); }
				if(P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_3a.palette ->data); }
				if(P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_3a.palette ->data); }
				if(P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_3a.palette ->data); }
				if(P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_3a.palette ->data); }
				if(P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_3a.palette ->data); } 
			}
		}
	...
	{ 
		...
		if(P[1].id==1) //haohmaru
		{
			if(P[1].rageLvl==0)
			{
				if(P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_1b.palette ->data); }
				if(P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_1b.palette ->data); }
				if(P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_1b.palette ->data); }
				if(P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_1b.palette ->data); }
				if(P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_1b.palette ->data); }
				if(P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_1b.palette ->data); }
				if(P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_1b.palette ->data); }
				if(P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_1b.palette ->data); } 
			}
			if(P[1].rageLvl==1)
			{
				if(P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_2b.palette ->data); }
				if(P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_2b.palette ->data); }
				if(P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_2b.palette ->data); }
				if(P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_2b.palette ->data); }
				if(P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_2b.palette ->data); }
				if(P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_2b.palette ->data); }
				if(P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_2b.palette ->data); }
				if(P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_2b.palette ->data); } 
			}
			if(P[1].rageLvl==2)
			{
				if(P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_3b.palette ->data); }
				if(P[1].palID==2){ VDP_setPalette(PAL2, spr_haohmaru_pal2_3b.palette ->data); }
				if(P[1].palID==3){ VDP_setPalette(PAL2, spr_haohmaru_pal3_3b.palette ->data); }
				if(P[1].palID==4){ VDP_setPalette(PAL2, spr_haohmaru_pal4_3b.palette ->data); }
				if(P[1].palID==5){ VDP_setPalette(PAL2, spr_haohmaru_pal5_3b.palette ->data); }
				if(P[1].palID==6){ VDP_setPalette(PAL2, spr_haohmaru_pal6_3b.palette ->data); }
				if(P[1].palID==7){ VDP_setPalette(PAL2, spr_haohmaru_pal7_3b.palette ->data); }
				if(P[1].palID==8){ VDP_setPalette(PAL2, spr_haohmaru_pal8_3b.palette ->data); } 
			}
		}
		...
		if(P[2].id==1) //haohmaru
		{
			if(P[2].rageLvl==0)
			{
				if(P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_1b.palette ->data); }
				if(P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_1b.palette ->data); }
				if(P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_1b.palette ->data); }
				if(P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_1b.palette ->data); }
				if(P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_1b.palette ->data); }
				if(P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_1b.palette ->data); }
				if(P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_1b.palette ->data); }
				if(P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_1b.palette ->data); } 
			}
			if(P[2].rageLvl==1)
			{
				if(P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_2b.palette ->data); }
				if(P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_2b.palette ->data); }
				if(P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_2b.palette ->data); }
				if(P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_2b.palette ->data); }
				if(P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_2b.palette ->data); }
				if(P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_2b.palette ->data); }
				if(P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_2b.palette ->data); }
				if(P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_2b.palette ->data); } 
			}
			if(P[2].rageLvl==2)
			{
				if(P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_3b.palette ->data); }
				if(P[2].palID==2){ VDP_setPalette(PAL3, spr_haohmaru_pal2_3b.palette ->data); }
				if(P[2].palID==3){ VDP_setPalette(PAL3, spr_haohmaru_pal3_3b.palette ->data); }
				if(P[2].palID==4){ VDP_setPalette(PAL3, spr_haohmaru_pal4_3b.palette ->data); }
				if(P[2].palID==5){ VDP_setPalette(PAL3, spr_haohmaru_pal5_3b.palette ->data); }
				if(P[2].palID==6){ VDP_setPalette(PAL3, spr_haohmaru_pal6_3b.palette ->data); }
				if(P[2].palID==7){ VDP_setPalette(PAL3, spr_haohmaru_pal7_3b.palette ->data); }
				if(P[2].palID==8){ VDP_setPalette(PAL3, spr_haohmaru_pal8_3b.palette ->data); } 
			}
		}
...
void FUNCAO_INICIALIZACAO()
{
	...
	if(P[1].id==1 && P[1].palID==1){ VDP_setPalette(PAL2, spr_haohmaru_pal1_1a.palette->data); } //haohmaru
	...
	if(P[2].id==1 && P[2].palID==1){ VDP_setPalette(PAL3, spr_haohmaru_pal1_1a.palette->data); } //haohmaru
