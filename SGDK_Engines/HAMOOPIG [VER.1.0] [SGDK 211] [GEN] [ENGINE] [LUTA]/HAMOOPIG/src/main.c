...
// HUD, camera, efeitos e configuracoes do cenario.
    ...
    while(TRUE) /// LOOP PRINCIPAL ///
    {
		...
		if(gRoom==2) //TELA DE APRESENTACAO -------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				PAL_setPalette(PAL1, bg_title_bga.palette->data, DMA);
				...
				PAL_setPalette(PAL2, spr_roman_two.palette->data, DMA);
				SPR_setDepth(GE[1].sprite, 255); 
				
				//Petalas
				
				PAL_setPalette(PAL3, spr_petala_big.palette->data, DMA);
		...
		if(gRoom==3) //CHAR SELECT ----------------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				PAL_setPalette(PAL2, spr_haohmaru_001.palette->data, DMA);
				...
				PAL_setPalette(PAL3, spr_gillius_001.palette->data, DMA);
			...
			*/
			...
			if(moverCursorP1==1) //P1
			{
				...
				if(cursorP1_ID==2)
				{
					...
					PAL_setPalette(PAL2, spr_gillius_001.palette->data, DMA);
			...
			if(moverCursorP2==1) //P2
			{
				...
				if(cursorP2_ID==1)
				{
					...
					PAL_setPalette(PAL3, spr_haohmaru_001.palette->data, DMA);
	...
	*/
	...
	{ 
		...
		if(P[1].id==1) //haohmaru
		{
			if(P[1].rageLvl==0)
			{
				if(P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_1a.palette ->data, DMA); } 
				if(P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_1a.palette ->data, DMA); } 
				if(P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_1a.palette ->data, DMA); } 
				if(P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_1a.palette ->data, DMA); } 
				if(P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_1a.palette ->data, DMA); } 
				if(P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_1a.palette ->data, DMA); } 
				if(P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_1a.palette ->data, DMA); } 
				if(P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_1a.palette ->data, DMA); } 
			}
			if(P[1].rageLvl==1)
			{
				if(P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_2a.palette ->data, DMA); } 
				if(P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_2a.palette ->data, DMA); } 
				if(P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_2a.palette ->data, DMA); } 
				if(P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_2a.palette ->data, DMA); } 
				if(P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_2a.palette ->data, DMA); } 
				if(P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_2a.palette ->data, DMA); } 
				if(P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_2a.palette ->data, DMA); } 
				if(P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_2a.palette ->data, DMA); } 
			}
			if(P[1].rageLvl==2)
			{
				if(P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_3a.palette ->data, DMA); } 
				if(P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_3a.palette ->data, DMA); } 
				if(P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_3a.palette ->data, DMA); } 
				if(P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_3a.palette ->data, DMA); } 
				if(P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_3a.palette ->data, DMA); } 
				if(P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_3a.palette ->data, DMA); } 
				if(P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_3a.palette ->data, DMA); } 
				if(P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_3a.palette ->data, DMA); } 
			}
		}
		...
		if(P[2].id==1) //haohmaru
		{
			if(P[2].rageLvl==0)
			{
				if(P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_1a.palette ->data, DMA); }
				if(P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_1a.palette ->data, DMA); }
				if(P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_1a.palette ->data, DMA); }
				if(P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_1a.palette ->data, DMA); }
				if(P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_1a.palette ->data, DMA); }
				if(P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_1a.palette ->data, DMA); }
				if(P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_1a.palette ->data, DMA); }
				if(P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_1a.palette ->data, DMA); } 
			}
			//P2
			if(P[2].rageLvl==1)
			{
				if(P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_2a.palette ->data, DMA); }
				if(P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_2a.palette ->data, DMA); }
				if(P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_2a.palette ->data, DMA); }
				if(P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_2a.palette ->data, DMA); }
				if(P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_2a.palette ->data, DMA); }
				if(P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_2a.palette ->data, DMA); }
				if(P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_2a.palette ->data, DMA); }
				if(P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_2a.palette ->data, DMA); } 
			}
			//P2
			if(P[2].rageLvl==2)
			{
				if(P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_3a.palette ->data, DMA); }
				if(P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_3a.palette ->data, DMA); }
				if(P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_3a.palette ->data, DMA); }
				if(P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_3a.palette ->data, DMA); }
				if(P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_3a.palette ->data, DMA); }
				if(P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_3a.palette ->data, DMA); }
				if(P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_3a.palette ->data, DMA); }
				if(P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_3a.palette ->data, DMA); } 
			}
		}
	...
	{ 
		...
		if(P[1].id==1) //haohmaru
		{
			if(P[1].rageLvl==0)
			{
				if(P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_1b.palette ->data, DMA); }
				if(P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_1b.palette ->data, DMA); }
				if(P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_1b.palette ->data, DMA); }
				if(P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_1b.palette ->data, DMA); }
				if(P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_1b.palette ->data, DMA); }
				if(P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_1b.palette ->data, DMA); }
				if(P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_1b.palette ->data, DMA); }
				if(P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_1b.palette ->data, DMA); } 
			}
			if(P[1].rageLvl==1)
			{
				if(P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_2b.palette ->data, DMA); }
				if(P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_2b.palette ->data, DMA); }
				if(P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_2b.palette ->data, DMA); }
				if(P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_2b.palette ->data, DMA); }
				if(P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_2b.palette ->data, DMA); }
				if(P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_2b.palette ->data, DMA); }
				if(P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_2b.palette ->data, DMA); }
				if(P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_2b.palette ->data, DMA); } 
			}
			if(P[1].rageLvl==2)
			{
				if(P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_3b.palette ->data, DMA); }
				if(P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_3b.palette ->data, DMA); }
				if(P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_3b.palette ->data, DMA); }
				if(P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_3b.palette ->data, DMA); }
				if(P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_3b.palette ->data, DMA); }
				if(P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_3b.palette ->data, DMA); }
				if(P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_3b.palette ->data, DMA); }
				if(P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_3b.palette ->data, DMA); } 
			}
		}
		...
		if(P[2].id==1) //haohmaru
		{
			if(P[2].rageLvl==0)
			{
				if(P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_1b.palette ->data, DMA); }
				if(P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_1b.palette ->data, DMA); }
				if(P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_1b.palette ->data, DMA); }
				if(P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_1b.palette ->data, DMA); }
				if(P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_1b.palette ->data, DMA); }
				if(P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_1b.palette ->data, DMA); }
				if(P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_1b.palette ->data, DMA); }
				if(P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_1b.palette ->data, DMA); } 
			}
			if(P[2].rageLvl==1)
			{
				if(P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_2b.palette ->data, DMA); }
				if(P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_2b.palette ->data, DMA); }
				if(P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_2b.palette ->data, DMA); }
				if(P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_2b.palette ->data, DMA); }
				if(P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_2b.palette ->data, DMA); }
				if(P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_2b.palette ->data, DMA); }
				if(P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_2b.palette ->data, DMA); }
				if(P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_2b.palette ->data, DMA); } 
			}
			if(P[2].rageLvl==2)
			{
				if(P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_3b.palette ->data, DMA); }
				if(P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_3b.palette ->data, DMA); }
				if(P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_3b.palette ->data, DMA); }
				if(P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_3b.palette ->data, DMA); }
				if(P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_3b.palette ->data, DMA); }
				if(P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_3b.palette ->data, DMA); }
				if(P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_3b.palette ->data, DMA); }
				if(P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_3b.palette ->data, DMA); } 
			}
		}
...
void FUNCAO_INICIALIZACAO()
{
	...
	if(P[1].id==1 && P[1].palID==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_1a.palette->data, DMA); } //haohmaru
	...
	if(P[2].id==1 && P[2].palID==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_1a.palette->data, DMA); } //haohmaru
