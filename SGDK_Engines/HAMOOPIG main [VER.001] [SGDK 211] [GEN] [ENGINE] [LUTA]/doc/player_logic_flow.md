# Player Logic Flow - HAMOOPIG main [VER.001] [SGDK 211] [GEN] [ENGINE] [LUTA]

This document describes the player control flow and state management for the HAMOOPIG main [VER.001] [SGDK 211] [GEN] [ENGINE] [LUTA].
