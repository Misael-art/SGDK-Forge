...
// Guia rapido para leitura:
// 1. as definicoes e variaveis globais montam o estado da engine;
// 2. gRoom escolhe qual tela ou modo esta ativo;
// 3. a luta em si vive na Room 10, com input, animacao, FSM, fisica e camera.
...
//--- VARIAVEIS ---//
// O projeto usa bastante estado global porque cada room compartilha personagens,
// HUD, camera, efeitos, menus e configuracoes do cenario.
...
// O main prepara SGDK e depois despacha o jogo pelo valor de gRoom.
// Pense nele como um "hub" que troca entre telas, menus e combate.
int main(u16 hard) /************** MAIN **************/
{
    ...
    while(TRUE) /// LOOP PRINCIPAL ///
    {
		...
		// gRoom funciona como uma maquina de telas:
		// abertura, menu, selecoes, descompressao, luta e pos-luta.
		if(gRoom==1) //TELA HAMOOPIG --------------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				PAL_setPalette(PAL0, room_0_bga.palette->data, DMA);
				PAL_setPalette(PAL1, room_0_bgb.palette->data, DMA);
		...
		if(gRoom==2) //TELA DE APRESENTACAO -------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				PAL_setPalette(PAL0, bg_title_bgb.palette->data, DMA);
				...
				PAL_setPalette(PAL1, bg_title_bga1.palette->data, DMA);
				gInd_tileset += bg_title_bga1.tileset->numTile;
				
				VDP_setBackgroundColor(15); //Range 0-63 //4 Paletas de 16 cores = 64 cores
				
				GE[1].sprite = SPR_addSpriteExSafe(&bone_terry, 111, 134, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				PAL_setPalette(PAL2, bone_terry.palette->data, DMA);
			...
			if(gFrames==16*1)
			{
				...
				PAL_setPalette(PAL1, bg_title_bga2.palette->data, DMA);
			...
			if(gFrames==16*2)
			{
				...
				PAL_setPalette(PAL1, bg_title_bga3.palette->data, DMA);
			...
			if(gFrames==16*3)
			{
				...
				PAL_setPalette(PAL1, bg_title_bga4.palette->data, DMA);
		...
		if(gRoom==3) //CHAR SELECT ----------------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				PAL_setPalette(PAL0, bg_char_select_bgb.palette->data, DMA);
				...
				PAL_setPalette(PAL1, bg_char_select_bga.palette->data, DMA);
				gInd_tileset += bg_char_select_bga.tileset->numTile;
				
				//icon VS
				GE[1].sprite = SPR_addSpriteExSafe(&spr_icon_vs, 136, 104, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				SPR_setVRAMTileIndex(GE[1].sprite, 1461); //define uma posicao especifica para o GFX na VRAM
				PAL_setPalette(PAL1, spr_icon_vs.palette->data, DMA);
				
				//Retratos grandes
				GE[3].sprite = SPR_addSpriteExSafe(&spr_terry_001,  32, 64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				PAL_setPalette(PAL2, spr_terry_001.palette->data, DMA);
				GE[4].sprite = SPR_addSpriteExSafe(&spr_terry_001, 192, 64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				PAL_setPalette(PAL3, spr_terry_001.palette->data, DMA);
				SPR_setHFlip(GE[4].sprite, TRUE);
				
				//Nomes
				GE[5].sprite = SPR_addSpriteExSafe(&spr_terry_name,  32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				GE[6].sprite = SPR_addSpriteExSafe(&spr_terry_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
			...
			*/
			...
			if(moverCursorP1==1) //P1
			{
				...
				if(cursorP1_ID==2)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_andy_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_andy_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_andy_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==3)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_joe_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_joe_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_joe_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==4)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_richard_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_richard_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_richard_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==5)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_michael_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_michael_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_michael_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==6)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_duck_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_duck_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_duck_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==7)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_tung_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_tung_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_tung_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==8)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_hwa_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_hwa_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_hwa_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==9)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_raiden_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_raiden_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_raiden_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==10)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_billy_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_billy_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_billy_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP1_ID==11)
				{
					GE[3].sprite = SPR_addSpriteExSafe(&spr_geese_001,  32,  64, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL2, spr_geese_001.palette->data, DMA);
					GE[5].sprite = SPR_addSpriteExSafe(&spr_geese_name, 32, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
			}//---end P1
			...
			if(moverCursorP2==1) //P2
			{
				...
				if(cursorP2_ID==2)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_andy_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_andy_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_andy_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==3)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_joe_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_joe_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_joe_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==4)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_richard_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_richard_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_richard_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==5)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_michael_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_michael_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_michael_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==6)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_duck_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_duck_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_duck_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==7)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_tung_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_tung_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_tung_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==8)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_hwa_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_hwa_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_hwa_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==9)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_raiden_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_raiden_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_raiden_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==10)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_billy_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_billy_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_billy_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				if(cursorP2_ID==11)
				{
					GE[4].sprite = SPR_addSpriteExSafe(&spr_geese_001,  192,  64, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
					PAL_setPalette(PAL3, spr_geese_001.palette->data, DMA);
					GE[6].sprite = SPR_addSpriteExSafe(&spr_geese_name, 192, 168, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
				}
				SPR_setHFlip(GE[4].sprite, TRUE);
				//SPR_setHFlip(GE[6].sprite, TRUE);
			}//---end P2
			...
			if(cursorP1ConfirmFX<cursorConfirmTimer)
			{
				if(cursorP1ConfirmFX>0)
				{
					...
					if(mudarcor==1)
					{
						...
						{
							if(cursorP1ColorChoice==1){ PAL_setPalette(PAL2, spr_haohmaru_pal1_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_1a.palette->data, DMA); }
							if(cursorP1ColorChoice==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_1a.palette->data, DMA); }
						}
						if(cursorP1_ID==2) //gillius
						{
							/*
							if(cursorP1ColorChoice==1){ PAL_setPalette(PAL2, spr_gillius_pal1.palette->data, DMA); }
							if(cursorP1ColorChoice==2){ PAL_setPalette(PAL2, spr_gillius_pal2.palette->data, DMA); }
							if(cursorP1ColorChoice==3){ PAL_setPalette(PAL2, spr_gillius_pal3.palette->data, DMA); }
							if(cursorP1ColorChoice==4){ PAL_setPalette(PAL2, spr_gillius_pal4.palette->data, DMA); }
							if(cursorP1ColorChoice==5){ PAL_setPalette(PAL2, spr_gillius_pal5.palette->data, DMA); }
							if(cursorP1ColorChoice==6){ PAL_setPalette(PAL2, spr_gillius_pal6.palette->data, DMA); }
							if(cursorP1ColorChoice==7){ PAL_setPalette(PAL2, spr_gillius_pal7.palette->data, DMA); }
							if(cursorP1ColorChoice==8){ PAL_setPalette(PAL2, spr_gillius_pal8.palette->data, DMA); }
							*/
						}
			...
			if(cursorP2ConfirmFX<cursorConfirmTimer)
			{
				if(cursorP2ConfirmFX>0)
				{
					...
					if(mudarcor==1)
					{
						...
						{
							if(cursorP2ColorChoice==1){ PAL_setPalette(PAL3, spr_haohmaru_pal1_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_1a.palette->data, DMA); }
							if(cursorP2ColorChoice==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_1a.palette->data, DMA); }
						}
						if(cursorP2_ID==2) //gillius
						{
							/*
							if(cursorP2ColorChoice==1){ PAL_setPalette(PAL3, spr_gillius_pal1.palette->data, DMA); }
							if(cursorP2ColorChoice==2){ PAL_setPalette(PAL3, spr_gillius_pal2.palette->data, DMA); }
							if(cursorP2ColorChoice==3){ PAL_setPalette(PAL3, spr_gillius_pal3.palette->data, DMA); }
							if(cursorP2ColorChoice==4){ PAL_setPalette(PAL3, spr_gillius_pal4.palette->data, DMA); }
							if(cursorP2ColorChoice==5){ PAL_setPalette(PAL3, spr_gillius_pal5.palette->data, DMA); }
							if(cursorP2ColorChoice==6){ PAL_setPalette(PAL3, spr_gillius_pal6.palette->data, DMA); }
							if(cursorP2ColorChoice==7){ PAL_setPalette(PAL3, spr_gillius_pal7.palette->data, DMA); }
							if(cursorP2ColorChoice==8){ PAL_setPalette(PAL3, spr_gillius_pal8.palette->data, DMA); }
							*/
						}
						//Movimentacao de Sprite do cursor de cor
		...
		if(gRoom==4) //STAGE SELECT ---------------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				PAL_setPalette(PAL0, bg_stage_select_bgb.palette->data, DMA);
				...
				PAL_setPalette(PAL1, bg_stage1_select_bga.palette->data, DMA);
				...
				PAL_setPalette(PAL3, spr_BG_desc1.palette->data, DMA);
				...
				//PAL_setPalette(PAL2, kuroko_shoulder.palette->data, DMA);
			...
			if(atualizaMiniatura==1)
			{
				...
				if(gBG_Choice==2)
				{
					...
					PAL_setPalette(PAL1, bg_stage2_select_bga.palette->data, DMA);
				}
				if(gBG_Choice==3)
				{
					...
					PAL_setPalette(PAL1, bg_stage3_select_bga.palette->data, DMA);
				}
			}
		...
		// Room 10 e o coracao da engine de luta.
		// A ordem abaixo e a espinha dorsal do frame de combate.
		if(gRoom==10) //IN GAME -------------------------------------------------------------------
		{
		...
		if(gRoom==11) //AFTER MATCH ---------------------------------------------------------------
		{
			...
			if(gFrames==1)
			{
				...
				if(gBG_Choice==1)
				{
					...
					PAL_setPalette(PAL0, gfx_bgb1_win_screen.palette->data, DMA);
				...
				if(gBG_Choice==2)
				{
					...
					PAL_setPalette(PAL0, gfx_bgb2_win_screen.palette->data, DMA);
				...
				if(gWinnerID==1) //haohmaru
				{
					...
					PAL_setPalette(PAL1, bg_win_haohmaru_bga.palette->data, DMA);
				...
				if(gWinnerID==2) //gillius
				{
					...
					PAL_setPalette(PAL1, bg_win_gillius_bga.palette->data, DMA);
				...
				if(gWinnerID==1) //haohmaru
				{
					...
					PAL_setPalette(PAL3, spr_haohmaru_win_phrase1A.palette->data, DMA);
				}
				if(gWinnerID==2) //gillius
				{
					/*
					...
					PAL_setPalette(PAL3, spr_gillius_win_phrase1A.palette->data, DMA);
					*/
				}
...
void PLAYER_STATE(u8 Player, u16 State)
{
	...
	if(P[Player].id==1)
	{
		if(State==100){
			...
			P[Player].sprite = SPR_addSpriteExSafe(&spr_terry_100, P[Player].x-P[Player].axisX, P[Player].y-P[Player].axisY, TILE_ATTR(P[Player].paleta, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
		}
		if(State==101){
			P[Player].w = 19*8;
			P[Player].h = 19*8;
		...
		if(State==610){
			...
			P[Player].animFrameTotal = 4;
			P[Player].sprite = SPR_addSpriteExSafe(&spr_terry_610, P[Player].x-P[Player].axisX, P[Player].y-P[Player].axisY, TILE_ATTR(P[Player].paleta, FALSE, FALSE, FALSE), SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
		}
		if(State==611){
			P[Player].w = 17*8;
			P[Player].h = 26*8;
...
void FUNCAO_RELOGIO()
{
	...
	if(gClockTimer==0)
	{
		...
		if(gClockRTimer==9){ ClockR = SPR_addSpriteEx(&spr_n9, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==8){ ClockR = SPR_addSpriteEx(&spr_n8, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==7){ ClockR = SPR_addSpriteEx(&spr_n7, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==6){ ClockR = SPR_addSpriteEx(&spr_n6, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==5){ ClockR = SPR_addSpriteEx(&spr_n5, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==4){ ClockR = SPR_addSpriteEx(&spr_n4, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==3){ ClockR = SPR_addSpriteEx(&spr_n3, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==2){ ClockR = SPR_addSpriteEx(&spr_n2, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==1){ ClockR = SPR_addSpriteEx(&spr_n1, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		if(gClockRTimer==0){ ClockR = SPR_addSpriteEx(&spr_n0, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
		...
		if(gClockRTimer==-1)
		{
			if(gClockLTimer>0)
			{
				...
				if(gClockLTimer==9){ ClockL = SPR_addSpriteEx(&spr_n9, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==8){ ClockL = SPR_addSpriteEx(&spr_n8, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==7){ ClockL = SPR_addSpriteEx(&spr_n7, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==6){ ClockL = SPR_addSpriteEx(&spr_n6, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==5){ ClockL = SPR_addSpriteEx(&spr_n5, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==4){ ClockL = SPR_addSpriteEx(&spr_n4, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==3){ ClockL = SPR_addSpriteEx(&spr_n3, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==2){ ClockL = SPR_addSpriteEx(&spr_n2, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==1){ ClockL = SPR_addSpriteEx(&spr_n1, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				if(gClockLTimer==0){ ClockL = SPR_addSpriteEx(&spr_n0, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
				gClockRTimer=9;
				SPR_releaseSprite(ClockR);
				ClockR = SPR_addSpriteEx(&spr_n9, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
			}
		}
	...
	//{ 
		/*TIMER OVER!*/ 
		//ClockR = SPR_addSpriteEx(&spr_n0, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
		//SPR_setVRAMTileIndex(ClockR,1707); //define uma posicao especifica para o GFX na VRAM
	//}
}
...
void FUNCAO_INICIALIZACAO()
{
	...
	if(gBG_Choice==1){ 
		...
		PAL_setPalette(PAL0, gfx_bgb1A.palette->data, DMA);
	...
	PAL_setPalette(PAL1, spr_n0.palette->data, DMA); 
	...
	//Retratos
	if(P[1].id==1){ GE[16].sprite = SPR_addSpriteExSafe(&spr_terry_000, 0, 24, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
	if(P[1].id==2){ GE[16].sprite = SPR_addSpriteExSafe(&spr_terry_000,  0, 24, TILE_ATTR(PAL2, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
	SPR_setDepth(GE[16].sprite, 255 );
	SPR_setVRAMTileIndex(GE[16].sprite, 1522); //define uma posicao especifica para o GFX na VRAM
	
	if(P[2].id==1){ GE[17].sprite = SPR_addSpriteExSafe(&spr_terry_000, 304, 24, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
	if(P[2].id==2){ GE[17].sprite = SPR_addSpriteExSafe(&spr_terry_000,  304, 24, TILE_ATTR(PAL3, FALSE, FALSE, FALSE), SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); }
	...
	ClockL = SPR_addSpriteEx(&spr_n9, 144, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	ClockR = SPR_addSpriteEx(&spr_n9, 160, 32, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	SPR_setVRAMTileIndex(ClockL,1703); //define uma posicao especifica para o GFX na VRAM
	SPR_setVRAMTileIndex(ClockR,1707); //define uma posicao especifica para o GFX na VRAM
	...
	Rect1BB1_Q1 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1BB1_Q2 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1BB1_Q3 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1BB1_Q4 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1HB1_Q1 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1HB1_Q2 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1HB1_Q3 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect1HB1_Q4 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	
	Rect2BB1_Q1 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2BB1_Q2 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2BB1_Q3 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2BB1_Q4 = SPR_addSpriteEx(&spr_rect_bb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2HB1_Q1 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2HB1_Q2 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2HB1_Q3 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	Rect2HB1_Q4 = SPR_addSpriteEx(&spr_rect_hb, -8, -8, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC);
	...
	if(P[1].id==1 && P[1].palID==1){ PAL_setPalette(PAL2, spr_terry_pal1.palette->data, DMA); } //terry
	if(P[1].id==1 && P[1].palID==2){ PAL_setPalette(PAL2, spr_haohmaru_pal2_1a.palette->data, DMA); } //haohmaru
	if(P[1].id==1 && P[1].palID==3){ PAL_setPalette(PAL2, spr_haohmaru_pal3_1a.palette->data, DMA); } //haohmaru
	if(P[1].id==1 && P[1].palID==4){ PAL_setPalette(PAL2, spr_haohmaru_pal4_1a.palette->data, DMA); } //haohmaru
	if(P[1].id==1 && P[1].palID==5){ PAL_setPalette(PAL2, spr_haohmaru_pal5_1a.palette->data, DMA); } //haohmaru
	if(P[1].id==1 && P[1].palID==6){ PAL_setPalette(PAL2, spr_haohmaru_pal6_1a.palette->data, DMA); } //haohmaru
	if(P[1].id==1 && P[1].palID==7){ PAL_setPalette(PAL2, spr_haohmaru_pal7_1a.palette->data, DMA); } //haohmaru
	if(P[1].id==1 && P[1].palID==8){ PAL_setPalette(PAL2, spr_haohmaru_pal8_1a.palette->data, DMA); } //haohmaru
	
	/*
	if(P[1].id==2 && P[1].palID==1){ PAL_setPalette(PAL2, spr_gillius_pal1.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==2){ PAL_setPalette(PAL2, spr_gillius_pal2.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==3){ PAL_setPalette(PAL2, spr_gillius_pal3.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==4){ PAL_setPalette(PAL2, spr_gillius_pal4.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==5){ PAL_setPalette(PAL2, spr_gillius_pal5.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==6){ PAL_setPalette(PAL2, spr_gillius_pal6.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==7){ PAL_setPalette(PAL2, spr_gillius_pal7.palette->data, DMA); } //gillius
	if(P[1].id==2 && P[1].palID==8){ PAL_setPalette(PAL2, spr_gillius_pal8.palette->data, DMA); } //gillius
	*/
	
	if(P[2].id==1 && P[2].palID==1){ PAL_setPalette(PAL3, spr_terry_pal1.palette->data, DMA); } //terry
	if(P[2].id==1 && P[2].palID==2){ PAL_setPalette(PAL3, spr_haohmaru_pal2_1a.palette->data, DMA); } //haohmaru
	if(P[2].id==1 && P[2].palID==3){ PAL_setPalette(PAL3, spr_haohmaru_pal3_1a.palette->data, DMA); } //haohmaru
	if(P[2].id==1 && P[2].palID==4){ PAL_setPalette(PAL3, spr_haohmaru_pal4_1a.palette->data, DMA); } //haohmaru
	if(P[2].id==1 && P[2].palID==5){ PAL_setPalette(PAL3, spr_haohmaru_pal5_1a.palette->data, DMA); } //haohmaru
	if(P[2].id==1 && P[2].palID==6){ PAL_setPalette(PAL3, spr_haohmaru_pal6_1a.palette->data, DMA); } //haohmaru
	if(P[2].id==1 && P[2].palID==7){ PAL_setPalette(PAL3, spr_haohmaru_pal7_1a.palette->data, DMA); } //haohmaru
	if(P[2].id==1 && P[2].palID==8){ PAL_setPalette(PAL3, spr_haohmaru_pal8_1a.palette->data, DMA); } //haohmaru
	
	/*
	if(P[2].id==2 && P[2].palID==1){ PAL_setPalette(PAL3, spr_gillius_pal1.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==2){ PAL_setPalette(PAL3, spr_gillius_pal2.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==3){ PAL_setPalette(PAL3, spr_gillius_pal3.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==4){ PAL_setPalette(PAL3, spr_gillius_pal4.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==5){ PAL_setPalette(PAL3, spr_gillius_pal5.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==6){ PAL_setPalette(PAL3, spr_gillius_pal6.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==7){ PAL_setPalette(PAL3, spr_gillius_pal7.palette->data, DMA); } //gillius
	if(P[2].id==2 && P[2].palID==8){ PAL_setPalette(PAL3, spr_gillius_pal8.palette->data, DMA); } //gillius
	*/
...
void FUNCAO_ROUND_INIT()
{
	/*samsho2*/ //-Intro Rotine -BEGIN-//
	 if(gFrames== 3){ 
		...
		//Gairyu Isle Evening
		if(gBG_Choice==1){ HUD_Lethers = SPR_addSpriteEx(&spr_BG_desc1, 72, 48, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
		//Gairyu Isle Night
		if(gBG_Choice==2){ HUD_Lethers = SPR_addSpriteEx(&spr_BG_desc2, 72, 48, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
		//Himalaya Top of The Montain
		if(gBG_Choice==3){ HUD_Lethers = SPR_addSpriteEx(&spr_BG_desc3, 72, 48, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
	 }
	 ...
	 if(gFrames== 65){ HUD_Lethers = SPR_addSpriteEx(&spr_engarde, 96, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
	 ...
	 if(gFrames==193)
	 { 
		if(gRound==1){ HUD_Lethers = SPR_addSpriteEx(&spr_duel1, 112, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
		if(gRound==2){ HUD_Lethers = SPR_addSpriteEx(&spr_duel2, 112, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
		if(gRound==3){ HUD_Lethers = SPR_addSpriteEx(&spr_duel3, 112, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
		if(gRound==4){ HUD_Lethers = SPR_addSpriteEx(&spr_duel4, 112, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
		if(gRound==5){ HUD_Lethers = SPR_addSpriteEx(&spr_duel5, 112, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
	 }
	 ...
	 if(gFrames==293){ HUD_Lethers = SPR_addSpriteEx(&spr_begin, 120, 64, TILE_ATTR(PAL1, FALSE, FALSE, FALSE), 1, SPR_FLAG_DISABLE_DELAYED_FRAME_UPDATE | SPR_FLAG_AUTO_VISIBILITY | SPR_FLAG_AUTO_VRAM_ALLOC | SPR_FLAG_AUTO_TILE_UPLOAD | SPR_FLAG_AUTO_VRAM_ALLOC); SPR_setDepth(HUD_Lethers, 1 ); }
	 ...
	 if(gFrames==352)
	 {
		...
		PAL_setPalette(PAL1, gfx_bga.palette->data, DMA);
