# Player Logic Flow - Jump Tutorial Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [PLATAFORMA]

This document describes the player control flow and state management for the Jump Tutorial Assets [VER.001] [SGDK 211] [GEN] [COLLECTION] [PLATAFORMA].
