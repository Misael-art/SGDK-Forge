# Player Logic Flow - KleleAtoms MD [VER.001] [SGDK 211] [GEN] [GAME] [PUZZLE]

This document describes the player control flow and state management for the KleleAtoms MD [VER.001] [SGDK 211] [GEN] [GAME] [PUZZLE].
...
The project uses active input handlers: joyEventHandler
