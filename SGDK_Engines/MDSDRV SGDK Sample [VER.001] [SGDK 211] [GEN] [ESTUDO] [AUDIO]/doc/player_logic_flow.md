# Player Logic Flow - MDSDRV SGDK Sample [VER.001] [SGDK 211] [GEN] [ESTUDO] [AUDIO]

This document describes the player control flow and state management for the MDSDRV SGDK Sample [VER.001] [SGDK 211] [GEN] [ESTUDO] [AUDIO].
...
```ascii
    [ START ] --> [ INIT ]
              ...
              [ STATE MACHINE ]
                     |
       MENU_ACTION_C -> ITEM_TEMPO -> MENU_ACTION_A -> MENU_ACTION_UD -> MENU_ACTION_START
                     |
