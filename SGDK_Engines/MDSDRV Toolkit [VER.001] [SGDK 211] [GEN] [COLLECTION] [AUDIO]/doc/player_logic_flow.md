# Player Logic Flow - MDSDRV Toolkit [VER.001] [SGDK 211] [GEN] [COLLECTION] [AUDIO]

This document describes the player control flow and state management for the MDSDRV Toolkit [VER.001] [SGDK 211] [GEN] [COLLECTION] [AUDIO].
