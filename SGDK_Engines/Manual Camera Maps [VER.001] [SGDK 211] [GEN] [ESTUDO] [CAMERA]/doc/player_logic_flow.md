# Player Logic Flow - Manual Camera Maps [VER.001] [SGDK 211] [GEN] [ESTUDO] [CAMERA]

This document describes the player control flow and state management for the Manual Camera Maps [VER.001] [SGDK 211] [GEN] [ESTUDO] [CAMERA].
