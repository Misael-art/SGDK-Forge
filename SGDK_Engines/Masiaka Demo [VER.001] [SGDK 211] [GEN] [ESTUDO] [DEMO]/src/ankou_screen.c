...
NOINLINE void ankouScreenFX(void){
	...
	/* Pic 0 */
	VDP_drawImageEx(BG_B, &exocet_ankou_front_0, TILE_ATTR_FULL(PAL1, TRUE, FALSE, FALSE, vramIndex), 0, 0,  FALSE, TRUE);
	vramIndex += exocet_ankou_front_0.tileset->numTile;

	VDP_drawImageEx(BG_B, &exocet_ankou_front_1, TILE_ATTR_FULL(PAL1, TRUE, FALSE, FALSE, vramIndex), 80 >> 3, 0, FALSE, TRUE);
	vramIndex += exocet_ankou_front_1.tileset->numTile;

	VDP_drawImageEx(BG_B, &exocet_ankou_front_2, TILE_ATTR_FULL(PAL1, TRUE, FALSE, FALSE, vramIndex), 160 >> 3, 0, FALSE, TRUE);
	vramIndex += exocet_ankou_front_2.tileset->numTile;

	VDP_drawImageEx(BG_B, &exocet_ankou_front_3, TILE_ATTR_FULL(PAL1, TRUE, FALSE, FALSE, vramIndex), 240 >> 3, 0, FALSE, TRUE);
	...
	VDP_drawImageEx(BG_A, &exocet_ankou_back_0, TILE_ATTR_FULL(PAL0, TRUE, FALSE, FALSE, vramIndex), 0, 0, FALSE, TRUE);
	vramIndex += exocet_ankou_back_0.tileset->numTile;

	VDP_drawImageEx(BG_A, &exocet_ankou_back_1, TILE_ATTR_FULL(PAL0, TRUE, FALSE, FALSE, vramIndex), 80 >> 3, 0, FALSE, TRUE);
	vramIndex += exocet_ankou_back_1.tileset->numTile;

	VDP_drawImageEx(BG_A, &exocet_ankou_back_2, TILE_ATTR_FULL(PAL0, TRUE, FALSE, FALSE, vramIndex), 160 >> 3, 0, FALSE, TRUE);
	vramIndex += exocet_ankou_back_2.tileset->numTile;

	VDP_drawImageEx(BG_A, &exocet_ankou_back_3, TILE_ATTR_FULL(PAL0, TRUE, FALSE, FALSE, vramIndex), 240 >> 3, 0, FALSE, TRUE);
		...
		switch(f_step)
		{
			case 0:
				if (!fading && music_sync > 7750 + 50)
				{
					...
					PAL_fade(16, 31, palette_black, palette_white, 4, TRUE);
					PAL_interruptFade();
					fading = 1;						
					f_step++;
				}
			...
			case 1:
				...
				{
					// KLog_U1("-> f_step = ", f_step);
					PAL_fade(16, 31, palette_white, pal_fx0, 8, TRUE);
					PAL_interruptFade();
					fading = 1;
					f_step++;		
				}
			...
			case 2:
				...
				{
					// KLog_U1("-> f_step = ", f_step);
					PAL_fade(16, 31, pal_fx0, palette_white, 4, TRUE);
					PAL_interruptFade();
					fading = 1;						
					f_step++;
				}
			...
			case 3:
				...
				{
					// KLog_U1("-> f_step = ", f_step);
					PAL_fade(16, 31, palette_white, exocet_ankou_front_0.palette->data, RSE_FRAMES(16), TRUE);
					PAL_interruptFade();
					fading = 1;
					f_step++;		
				}
			...
			case 4:
				...
				{
					// KLog_U1("-> f_step = ", f_step);
					PAL_fade(0, 15, palette_black, pal_fx1, 4, TRUE);
					PAL_interruptFade();
					fading = 1;						
					f_step++;
				}
			...
			case 5:
				...
				{
					// KLog_U1("-> f_step = ", f_step);
					PAL_fade(0, 15, pal_fx1, exocet_ankou_back_0.palette->data, RSE_FRAMES(16), TRUE);
					PAL_interruptFade();
					fading = 1;
					f_step++;		
				}
	...
	PAL_fadeOut(1, 63, RSE_FRAMES(16), FALSE);
