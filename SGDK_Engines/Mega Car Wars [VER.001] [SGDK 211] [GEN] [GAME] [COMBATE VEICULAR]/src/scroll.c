...
void Scroll_cameraUpdate()
{
        ...
        VDP_setHorizontalScroll(BG_A, F32_toInt(-camera.posx));
        VDP_setHorizontalScroll(BG_B, F32_toInt(-camera.posx));

        VDP_setVerticalScroll(BG_A,F32_toInt(camera.posy));
        VDP_setVerticalScroll(BG_B,F32_toInt(camera.posy));
}
