# Player Logic Flow - Mega Pong Expanded [VER.001] [SGDK 211] [GEN] [GAME] [ARCADE]

This document describes the player control flow and state management for the Mega Pong Expanded [VER.001] [SGDK 211] [GEN] [GAME] [ARCADE].
