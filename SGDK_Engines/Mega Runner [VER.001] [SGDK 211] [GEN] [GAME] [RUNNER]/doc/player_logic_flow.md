# Player Logic Flow - Mega Runner [VER.001] [SGDK 211] [GEN] [GAME] [RUNNER]

This document describes the player control flow and state management for the Mega Runner [VER.001] [SGDK 211] [GEN] [GAME] [RUNNER].
