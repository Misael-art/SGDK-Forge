# Player Logic Flow - Mega Tetris [VER.0.8.2] [SGDK 211] [GEN] [GAME] [PUZZLE]

This document describes the player control flow and state management for the Mega Tetris [VER.0.8.2] [SGDK 211] [GEN] [GAME] [PUZZLE].
