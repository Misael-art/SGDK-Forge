# Player Logic Flow - MegaDriving [VER.1.0] [SGDK 211] [GEN] [ENGINE] [CORRIDA]

This document describes the player control flow and state management for the MegaDriving [VER.1.0] [SGDK 211] [GEN] [ENGINE] [CORRIDA].
