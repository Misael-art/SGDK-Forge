...
// step for perspective steering 

// assumes centerline limited from -4 to 323, use +4 as the offset int
fastfix32 perspective_step_from_centerline[] = {

FASTFIX32( -1.6907 ), FASTFIX32( -1.6804 ), FASTFIX32( -1.6701 ), FASTFIX32( -1.6598 ), FASTFIX32( -1.6495 ), FASTFIX32( -1.6392 ), FASTFIX32( -1.6289 ), FASTFIX32( -1.6186 ), FASTFIX32( -1.6082 ), FASTFIX32( -1.5979 ), FASTFIX32( -1.5876 ), FASTFIX32( -1.5773 ), FASTFIX32( -1.5670 ), FASTFIX32( -1.5567 ), FASTFIX32( -1.5464 ), FASTFIX32( -1.5361 ), FASTFIX32( -1.5258 ), FASTFIX32( -1.5155 ), FASTFIX32( -1.5052 ), FASTFIX32( -1.4948 ), FASTFIX32( -1.4845 ), FASTFIX32( -1.4742 ), FASTFIX32( -1.4639 ), FASTFIX32( -1.4536 ), FASTFIX32( -1.4433 ), FASTFIX32( -1.4330 ), FASTFIX32( -1.4227 ), FASTFIX32( -1.4124 ), FASTFIX32( -1.4021 ), FASTFIX32( -1.3918 ), FASTFIX32( -1.3814 ), FASTFIX32( -1.3711 ), FASTFIX32( -1.3608 ), FASTFIX32( -1.3505 ), FASTFIX32( -1.3402 ), FASTFIX32( -1.3299 ), FASTFIX32( -1.3196 ), FASTFIX32( -1.3093 ), FASTFIX32( -1.2990 ), FASTFIX32( -1.2887 ), FASTFIX32( -1.2784 ), FASTFIX32( -1.2680 ), FASTFIX32( -1.2577 ), FASTFIX32( -1.2474 ), FASTFIX32( -1.2371 ), FASTFIX32( -1.2268 ), FASTFIX32( -1.2165 ), FASTFIX32( -1.2062 ), FASTFIX32( -1.1959 ), FASTFIX32( -1.1856 ), FASTFIX32( -1.1753 ), FASTFIX32( -1.1649 ), FASTFIX32( -1.1546 ), FASTFIX32( -1.1443 ), FASTFIX32( -1.1340 ), FASTFIX32( -1.1237 ), FASTFIX32( -1.1134 ), FASTFIX32( -1.1031 ), FASTFIX32( -1.0928 ), FASTFIX32( -1.0825 ), FASTFIX32( -1.0722 ), FASTFIX32( -1.0619 ), FASTFIX32( -1.0515 ), FASTFIX32( -1.0412 ), FASTFIX32( -1.0309 ), FASTFIX32( -1.0206 ), FASTFIX32( -1.0103 ), FASTFIX32( -1.0000 ), FASTFIX32( -0.9897 ), FASTFIX32( -0.9794 ), FASTFIX32( -0.9691 ), FASTFIX32( -0.9588 ), FASTFIX32( -0.9485 ), FASTFIX32( -0.9381 ), FASTFIX32( -0.9278 ), FASTFIX32( -0.9175 ), FASTFIX32( -0.9072 ), FASTFIX32( -0.8969 ), FASTFIX32( -0.8866 ), FASTFIX32( -0.8763 ), FASTFIX32( -0.8660 ), FASTFIX32( -0.8557 ), FASTFIX32( -0.8454 ), FASTFIX32( -0.8351 ), FASTFIX32( -0.8247 ), FASTFIX32( -0.8144 ), FASTFIX32( -0.8041 ), FASTFIX32( -0.7938 ), FASTFIX32( -0.7835 ), FASTFIX32( -0.7732 ), FASTFIX32( -0.7629 ), FASTFIX32( -0.7526 ), FASTFIX32( -0.7423 ), FASTFIX32( -0.7320 ), FASTFIX32( -0.7216 ), FASTFIX32( -0.7113 ), FASTFIX32( -0.7010 ), FASTFIX32( -0.6907 ), FASTFIX32( -0.6804 ), FASTFIX32( -0.6701 ), FASTFIX32( -0.6598 ), FASTFIX32( -0.6495 ), FASTFIX32( -0.6392 ), FASTFIX32( -0.6289 ), FASTFIX32( -0.6186 ), FASTFIX32( -0.6082 ), FASTFIX32( -0.5979 ), FASTFIX32( -0.5876 ), FASTFIX32( -0.5773 ), FASTFIX32( -0.5670 ), FASTFIX32( -0.5567 ), FASTFIX32( -0.5464 ), FASTFIX32( -0.5361 ), FASTFIX32( -0.5258 ), FASTFIX32( -0.5155 ), FASTFIX32( -0.5052 ), FASTFIX32( -0.4948 ), FASTFIX32( -0.4845 ), FASTFIX32( -0.4742 ), FASTFIX32( -0.4639 ), FASTFIX32( -0.4536 ), FASTFIX32( -0.4433 ), FASTFIX32( -0.4330 ), FASTFIX32( -0.4227 ), FASTFIX32( -0.4124 ), FASTFIX32( -0.4021 ), FASTFIX32( -0.3918 ), FASTFIX32( -0.3814 ), FASTFIX32( -0.3711 ), FASTFIX32( -0.3608 ), FASTFIX32( -0.3505 ), FASTFIX32( -0.3402 ), FASTFIX32( -0.3299 ), FASTFIX32( -0.3196 ), FASTFIX32( -0.3093 ), FASTFIX32( -0.2990 ), FASTFIX32( -0.2887 ), FASTFIX32( -0.2784 ), FASTFIX32( -0.2680 ), FASTFIX32( -0.2577 ), FASTFIX32( -0.2474 ), FASTFIX32( -0.2371 ), FASTFIX32( -0.2268 ), FASTFIX32( -0.2165 ), FASTFIX32( -0.2062 ), FASTFIX32( -0.1959 ), FASTFIX32( -0.1856 ), FASTFIX32( -0.1753 ), FASTFIX32( -0.1649 ), FASTFIX32( -0.1546 ), FASTFIX32( -0.1443 ), FASTFIX32( -0.1340 ), FASTFIX32( -0.1237 ), FASTFIX32( -0.1134 ), FASTFIX32( -0.1031 ), FASTFIX32( -0.0928 ), FASTFIX32( -0.0825 ), FASTFIX32( -0.0722 ), FASTFIX32( -0.0619 ), FASTFIX32( -0.0515 ), FASTFIX32( -0.0412 ), FASTFIX32( -0.0309 ), FASTFIX32( -0.0206 ), FASTFIX32( -0.0103 ), FASTFIX32( 0.0000 ), FASTFIX32( 0.0103 ), FASTFIX32( 0.0206 ), FASTFIX32( 0.0309 ), FASTFIX32( 0.0412 ), FASTFIX32( 0.0515 ), FASTFIX32( 0.0619 ), FASTFIX32( 0.0722 ), FASTFIX32( 0.0825 ), FASTFIX32( 0.0928 ), FASTFIX32( 0.1031 ), FASTFIX32( 0.1134 ), FASTFIX32( 0.1237 ), FASTFIX32( 0.1340 ), FASTFIX32( 0.1443 ), FASTFIX32( 0.1546 ), FASTFIX32( 0.1649 ), FASTFIX32( 0.1753 ), FASTFIX32( 0.1856 ), FASTFIX32( 0.1959 ), FASTFIX32( 0.2062 ), FASTFIX32( 0.2165 ), FASTFIX32( 0.2268 ), FASTFIX32( 0.2371 ), FASTFIX32( 0.2474 ), FASTFIX32( 0.2577 ), FASTFIX32( 0.2680 ), FASTFIX32( 0.2784 ), FASTFIX32( 0.2887 ), FASTFIX32( 0.2990 ), FASTFIX32( 0.3093 ), FASTFIX32( 0.3196 ), FASTFIX32( 0.3299 ), FASTFIX32( 0.3402 ), FASTFIX32( 0.3505 ), FASTFIX32( 0.3608 ), FASTFIX32( 0.3711 ), FASTFIX32( 0.3814 ), FASTFIX32( 0.3918 ), FASTFIX32( 0.4021 ), FASTFIX32( 0.4124 ), FASTFIX32( 0.4227 ), FASTFIX32( 0.4330 ), FASTFIX32( 0.4433 ), FASTFIX32( 0.4536 ), FASTFIX32( 0.4639 ), FASTFIX32( 0.4742 ), FASTFIX32( 0.4845 ), FASTFIX32( 0.4948 ), FASTFIX32( 0.5052 ), FASTFIX32( 0.5155 ), FASTFIX32( 0.5258 ), FASTFIX32( 0.5361 ), FASTFIX32( 0.5464 ), FASTFIX32( 0.5567 ), FASTFIX32( 0.5670 ), FASTFIX32( 0.5773 ), FASTFIX32( 0.5876 ), FASTFIX32( 0.5979 ), FASTFIX32( 0.6082 ), FASTFIX32( 0.6186 ), FASTFIX32( 0.6289 ), FASTFIX32( 0.6392 ), FASTFIX32( 0.6495 ), FASTFIX32( 0.6598 ), FASTFIX32( 0.6701 ), FASTFIX32( 0.6804 ), FASTFIX32( 0.6907 ), FASTFIX32( 0.7010 ), FASTFIX32( 0.7113 ), FASTFIX32( 0.7216 ), FASTFIX32( 0.7320 ), FASTFIX32( 0.7423 ), FASTFIX32( 0.7526 ), FASTFIX32( 0.7629 ), FASTFIX32( 0.7732 ), FASTFIX32( 0.7835 ), FASTFIX32( 0.7938 ), FASTFIX32( 0.8041 ), FASTFIX32( 0.8144 ), FASTFIX32( 0.8247 ), FASTFIX32( 0.8351 ), FASTFIX32( 0.8454 ), FASTFIX32( 0.8557 ), FASTFIX32( 0.8660 ), FASTFIX32( 0.8763 ), FASTFIX32( 0.8866 ), FASTFIX32( 0.8969 ), FASTFIX32( 0.9072 ), FASTFIX32( 0.9175 ), FASTFIX32( 0.9278 ), FASTFIX32( 0.9381 ), FASTFIX32( 0.9485 ), FASTFIX32( 0.9588 ), FASTFIX32( 0.9691 ), FASTFIX32( 0.9794 ), FASTFIX32( 0.9897 ), FASTFIX32( 1.0000 ), FASTFIX32( 1.0103 ), FASTFIX32( 1.0206 ), FASTFIX32( 1.0309 ), FASTFIX32( 1.0412 ), FASTFIX32( 1.0515 ), FASTFIX32( 1.0619 ), FASTFIX32( 1.0722 ), FASTFIX32( 1.0825 ), FASTFIX32( 1.0928 ), FASTFIX32( 1.1031 ), FASTFIX32( 1.1134 ), FASTFIX32( 1.1237 ), FASTFIX32( 1.1340 ), FASTFIX32( 1.1443 ), FASTFIX32( 1.1546 ), FASTFIX32( 1.1649 ), FASTFIX32( 1.1753 ), FASTFIX32( 1.1856 ), FASTFIX32( 1.1959 ), FASTFIX32( 1.2062 ), FASTFIX32( 1.2165 ), FASTFIX32( 1.2268 ), FASTFIX32( 1.2371 ), FASTFIX32( 1.2474 ), FASTFIX32( 1.2577 ), FASTFIX32( 1.2680 ), FASTFIX32( 1.2784 ), FASTFIX32( 1.2887 ), FASTFIX32( 1.2990 ), FASTFIX32( 1.3093 ), FASTFIX32( 1.3196 ), FASTFIX32( 1.3299 ), FASTFIX32( 1.3402 ), FASTFIX32( 1.3505 ), FASTFIX32( 1.3608 ), FASTFIX32( 1.3711 ), FASTFIX32( 1.3814 ), FASTFIX32( 1.3918 ), FASTFIX32( 1.4021 ), FASTFIX32( 1.4124 ), FASTFIX32( 1.4227 ), FASTFIX32( 1.4330 ), FASTFIX32( 1.4433 ), FASTFIX32( 1.4536 ), FASTFIX32( 1.4639 ), FASTFIX32( 1.4742 ), FASTFIX32( 1.4845 ), FASTFIX32( 1.4948 ), FASTFIX32( 1.5052 ), FASTFIX32( 1.5155 ), FASTFIX32( 1.5258 ), FASTFIX32( 1.5361 ), FASTFIX32( 1.5464 ), FASTFIX32( 1.5567 ), FASTFIX32( 1.5670 ), FASTFIX32( 1.5773 ), FASTFIX32( 1.5876 ), FASTFIX32( 1.5979 ), FASTFIX32( 1.6082 ), FASTFIX32( 1.6186 ), FASTFIX32( 1.6289 ), FASTFIX32( 1.6392 ), FASTFIX32( 1.6495 ), FASTFIX32( 1.6598 ), FASTFIX32( 1.6701 ), FASTFIX32( 1.6804 ),
};
...
void updatePlayer()
{
    ...
    if (playerSprite->speed > FASTFIX32(0.0))
    {
        ...
        //
        fastfix32 step = perspective_step_from_centerline[ FF32_toInt(centerLine) + 4 ];   //work around division overflow with LUT.
...
void update()
{
    ...
    for (u16 bgY = 223; bgY > 126; bgY--)
    {
        ...
        //kprintf(" bgY %d SCROLL_CENTER %d currentX %d xShift %d", bgY, SCROLL_CENTER, FF32_toInt(currentX), xShift ); 
