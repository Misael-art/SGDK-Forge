# MegaDriving Lou 00 Turns [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/00_turns`.
...
projeto/
  ...
  ../../upstream/lou/00_turns/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/00_turns/`.
...
2. Abra `../../upstream/lou/00_turns/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/00_turns`
- Foco pedagogico: Primeiro passo da familia Lou, focado em curvas basicas e leitura do algoritmo de pseudo-3D.
