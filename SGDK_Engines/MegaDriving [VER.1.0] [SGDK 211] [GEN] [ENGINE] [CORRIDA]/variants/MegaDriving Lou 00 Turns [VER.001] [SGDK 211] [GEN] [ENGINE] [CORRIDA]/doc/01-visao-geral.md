...
`MegaDriving Lou 00 Turns [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/lou/00_turns/src/`, `../../upstream/lou/00_turns/res/`, `../../upstream/lou/00_turns/inc/` e `../../upstream/lou/00_turns/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/lou/00_turns/src/main.c`
