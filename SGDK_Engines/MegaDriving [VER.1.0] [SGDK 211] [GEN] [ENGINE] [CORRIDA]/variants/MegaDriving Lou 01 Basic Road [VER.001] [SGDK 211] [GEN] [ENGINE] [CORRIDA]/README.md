# MegaDriving Lou 01 Basic Road [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/01_basic_road`.
...
projeto/
  ...
  ../../upstream/lou/01_basic_road/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/01_basic_road/`.
...
2. Abra `../../upstream/lou/01_basic_road/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/01_basic_road`
- Foco pedagogico: Introduz a estrada basica e consolida o fluxo minimo de renderizacao da pista.
