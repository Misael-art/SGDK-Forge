...
`MegaDriving Lou 01 Basic Road [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/lou/01_basic_road/src/`, `../../upstream/lou/01_basic_road/res/`, `../../upstream/lou/01_basic_road/inc/` e `../../upstream/lou/01_basic_road/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/lou/01_basic_road/src/main.c`
