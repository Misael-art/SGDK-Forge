# MegaDriving Lou 02 Hills [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/02_hills`.
...
projeto/
  ...
  ../../upstream/lou/02_hills/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/02_hills/`.
...
2. Abra `../../upstream/lou/02_hills/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/02_hills`
- Foco pedagogico: Estudo incremental sobre variacao vertical da pista e percepcao de relevo.
