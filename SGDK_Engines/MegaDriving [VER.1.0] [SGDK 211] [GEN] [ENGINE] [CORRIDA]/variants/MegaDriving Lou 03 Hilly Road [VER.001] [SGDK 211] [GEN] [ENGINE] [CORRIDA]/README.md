# MegaDriving Lou 03 Hilly Road [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/03_hilly_road`.
...
projeto/
  ...
  ../../upstream/lou/03_hilly_road/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/03_hilly_road/`.
...
2. Abra `../../upstream/lou/03_hilly_road/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/03_hilly_road`
- Foco pedagogico: Combina estrada e colinas para mostrar a interacao entre profundidade e topografia.
