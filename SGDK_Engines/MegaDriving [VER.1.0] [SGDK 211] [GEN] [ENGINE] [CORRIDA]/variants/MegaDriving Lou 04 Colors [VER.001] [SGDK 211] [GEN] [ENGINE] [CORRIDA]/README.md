# MegaDriving Lou 04 Colors [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/04_colors`.
...
projeto/
  ...
  ../../upstream/lou/04_colors/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/04_colors/`.
...
2. Abra `../../upstream/lou/04_colors/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/04_colors`
- Foco pedagogico: Explora colorizacao da pista e leitura visual do cenario com foco em didatica.
