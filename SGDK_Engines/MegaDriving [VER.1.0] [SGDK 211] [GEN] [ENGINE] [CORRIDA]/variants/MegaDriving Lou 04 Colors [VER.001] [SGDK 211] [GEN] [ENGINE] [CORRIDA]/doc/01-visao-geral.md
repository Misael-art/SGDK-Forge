...
`MegaDriving Lou 04 Colors [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/lou/04_colors/src/`, `../../upstream/lou/04_colors/res/`, `../../upstream/lou/04_colors/inc/` e `../../upstream/lou/04_colors/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/lou/04_colors/src/main.c`
