# MegaDriving Lou 05 Sprites [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/05_sprites`.
...
projeto/
  ...
  ../../upstream/lou/05_sprites/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/05_sprites/`.
...
2. Abra `../../upstream/lou/05_sprites/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/05_sprites`
- Foco pedagogico: Mostra a introducao de sprites sobre a estrada para objetos e referencia espacial.
