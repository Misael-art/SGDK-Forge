...
`MegaDriving Lou 05 Sprites [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/lou/05_sprites/src/`, `../../upstream/lou/05_sprites/res/`, `../../upstream/lou/05_sprites/inc/` e `../../upstream/lou/05_sprites/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/lou/05_sprites/src/main.c`
