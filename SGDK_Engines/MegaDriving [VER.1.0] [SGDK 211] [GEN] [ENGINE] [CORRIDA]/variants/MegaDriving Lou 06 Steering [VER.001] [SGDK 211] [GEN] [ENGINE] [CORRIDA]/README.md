# MegaDriving Lou 06 Steering [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/06_steering`.
...
projeto/
  ...
  ../../upstream/lou/06_steering/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/06_steering/`.
...
2. Abra `../../upstream/lou/06_steering/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/06_steering`
- Foco pedagogico: Aprofunda o controle de direcao e a sensacao de pilotagem na familia Lou.
