...
`MegaDriving Lou 06 Steering [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/lou/06_steering/src/`, `../../upstream/lou/06_steering/res/`, `../../upstream/lou/06_steering/inc/` e `../../upstream/lou/06_steering/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/lou/06_steering/src/main.c`
