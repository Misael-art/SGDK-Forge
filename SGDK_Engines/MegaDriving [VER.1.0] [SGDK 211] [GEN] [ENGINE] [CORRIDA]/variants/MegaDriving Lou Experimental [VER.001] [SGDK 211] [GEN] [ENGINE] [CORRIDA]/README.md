# MegaDriving Lou Experimental [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/lou/experimental`.
...
projeto/
  ...
  ../../upstream/lou/experimental/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/lou/experimental/`.
...
2. Abra `../../upstream/lou/experimental/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Lou`
- SGDK root preservado: `upstream/lou/experimental`
- Foco pedagogico: Area de experimentacao livre da familia Lou, util para comparar hipoteses e tecnicas.
