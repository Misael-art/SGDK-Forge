...
`MegaDriving Lou Experimental [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/lou/experimental/src/`, `../../upstream/lou/experimental/res/`, `../../upstream/lou/experimental/inc/` e `../../upstream/lou/experimental/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/lou/experimental/src/main.c`
