# MegaDriving Spacer Harry 2 [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/spacer/SpacerHarry2`.
...
projeto/
  ...
  ../../upstream/spacer/SpacerHarry2/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/spacer/SpacerHarry2/`.
...
2. Abra `../../upstream/spacer/SpacerHarry2/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Spacer`
- SGDK root preservado: `upstream/spacer/SpacerHarry2`
- Foco pedagogico: Evolucao do prototipo Spacer com outro arranjo de cenario e fluxo de testes.
