...
`MegaDriving Spacer Harry 2 [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/spacer/SpacerHarry2/src/`, `../../upstream/spacer/SpacerHarry2/res/`, `../../upstream/spacer/SpacerHarry2/inc/` e `../../upstream/spacer/SpacerHarry2/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/spacer/SpacerHarry2/src/main.c`
