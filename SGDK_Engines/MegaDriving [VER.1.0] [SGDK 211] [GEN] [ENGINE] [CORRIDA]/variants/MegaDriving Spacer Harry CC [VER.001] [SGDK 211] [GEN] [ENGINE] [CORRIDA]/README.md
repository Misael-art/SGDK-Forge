# MegaDriving Spacer Harry CC [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/spacer/SpacerHarryCC`.
...
projeto/
  ...
  ../../upstream/spacer/SpacerHarryCC/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/spacer/SpacerHarryCC/`.
...
2. Abra `../../upstream/spacer/SpacerHarryCC/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Spacer`
- SGDK root preservado: `upstream/spacer/SpacerHarryCC`
- Foco pedagogico: Ramo adicional da familia Spacer para comparar configuracoes e resultados visuais.
