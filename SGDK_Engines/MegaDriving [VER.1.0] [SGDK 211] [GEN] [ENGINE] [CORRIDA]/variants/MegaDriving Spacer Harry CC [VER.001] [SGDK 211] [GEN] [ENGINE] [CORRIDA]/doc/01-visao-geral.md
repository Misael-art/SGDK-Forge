...
`MegaDriving Spacer Harry CC [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/spacer/SpacerHarryCC/src/`, `../../upstream/spacer/SpacerHarryCC/res/`, `../../upstream/spacer/SpacerHarryCC/inc/` e `../../upstream/spacer/SpacerHarryCC/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/spacer/SpacerHarryCC/src/main.c`
