...
`MegaDriving Spacer Harry [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/spacer/SpacerHarry/src/`, `../../upstream/spacer/SpacerHarry/res/`, `../../upstream/spacer/SpacerHarry/inc/` e `../../upstream/spacer/SpacerHarry/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/spacer/SpacerHarry/src/main.c`
