# MegaDriving Streeter 01 Tile Test [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/streeter/01_tile_test`.
...
projeto/
  ...
  ../../upstream/streeter/01_tile_test/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/streeter/01_tile_test/`.
...
2. Abra `../../upstream/streeter/01_tile_test/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Streeter`
- SGDK root preservado: `upstream/streeter/01_tile_test`
- Foco pedagogico: Primeiro estudo da familia Streeter, concentrado em testes de tiles e base de estrada.
