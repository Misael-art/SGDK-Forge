...
`MegaDriving Streeter 01 Tile Test [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/streeter/01_tile_test/src/`, `../../upstream/streeter/01_tile_test/res/`, `../../upstream/streeter/01_tile_test/inc/` e `../../upstream/streeter/01_tile_test/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/streeter/01_tile_test/src/main.c`
