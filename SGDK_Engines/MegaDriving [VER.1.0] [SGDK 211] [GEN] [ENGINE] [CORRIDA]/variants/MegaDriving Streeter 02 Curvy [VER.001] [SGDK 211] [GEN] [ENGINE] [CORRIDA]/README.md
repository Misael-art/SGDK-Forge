# MegaDriving Streeter 02 Curvy [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/streeter/02_curvy`.
...
projeto/
  ...
  ../../upstream/streeter/02_curvy/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/streeter/02_curvy/`.
...
2. Abra `../../upstream/streeter/02_curvy/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Streeter`
- SGDK root preservado: `upstream/streeter/02_curvy`
- Foco pedagogico: Mostra como a familia Streeter aborda curvas e leitura de trajetoria.
