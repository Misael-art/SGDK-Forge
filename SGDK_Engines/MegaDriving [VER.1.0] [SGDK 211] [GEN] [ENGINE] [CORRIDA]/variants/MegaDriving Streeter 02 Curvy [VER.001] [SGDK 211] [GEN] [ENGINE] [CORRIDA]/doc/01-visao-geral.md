...
`MegaDriving Streeter 02 Curvy [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/streeter/02_curvy/src/`, `../../upstream/streeter/02_curvy/res/`, `../../upstream/streeter/02_curvy/inc/` e `../../upstream/streeter/02_curvy/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/streeter/02_curvy/src/main.c`
