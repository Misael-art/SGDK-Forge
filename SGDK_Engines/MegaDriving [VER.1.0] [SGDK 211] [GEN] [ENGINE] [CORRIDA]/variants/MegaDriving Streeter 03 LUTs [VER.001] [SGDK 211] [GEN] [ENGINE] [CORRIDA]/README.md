# MegaDriving Streeter 03 LUTs [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/streeter/03_luts`.
...
projeto/
  ...
  ../../upstream/streeter/03_luts/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/streeter/03_luts/`.
...
2. Abra `../../upstream/streeter/03_luts/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Streeter`
- SGDK root preservado: `upstream/streeter/03_luts`
- Foco pedagogico: Exemplo da familia Streeter orientado a tabelas de consulta e precomputacao.
