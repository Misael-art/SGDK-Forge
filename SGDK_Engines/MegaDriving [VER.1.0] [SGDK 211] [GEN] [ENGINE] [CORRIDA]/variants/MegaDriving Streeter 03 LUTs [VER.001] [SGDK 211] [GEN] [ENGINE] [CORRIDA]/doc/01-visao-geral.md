...
`MegaDriving Streeter 03 LUTs [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/streeter/03_luts/src/`, `../../upstream/streeter/03_luts/res/`, `../../upstream/streeter/03_luts/inc/` e `../../upstream/streeter/03_luts/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/streeter/03_luts/src/main.c`
