# MegaDriving Streeter 04 Drive [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/streeter/04_drive`.
...
projeto/
  ...
  ../../upstream/streeter/04_drive/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/streeter/04_drive/`.
...
2. Abra `../../upstream/streeter/04_drive/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Streeter`
- SGDK root preservado: `upstream/streeter/04_drive`
- Foco pedagogico: Versao mais proxima de uma direcao jogavel dentro da familia Streeter.
