...
`MegaDriving Streeter 04 Drive [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/streeter/04_drive/src/`, `../../upstream/streeter/04_drive/res/`, `../../upstream/streeter/04_drive/inc/` e `../../upstream/streeter/04_drive/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/streeter/04_drive/src/main.c`
