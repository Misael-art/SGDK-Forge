# MegaDriving Streeter Util Test Project [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]
...
**SGDK root real** fica em `../../upstream/streeter/UTIL/test_proj`.
...
projeto/
  ...
  ../../upstream/streeter/UTIL/test_proj/          # SGDK root real
...
- Edite codigo e recursos dentro de `../../upstream/streeter/UTIL/test_proj/`.
...
2. Abra `../../upstream/streeter/UTIL/test_proj/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
...
- Familia: `Streeter`
- SGDK root preservado: `upstream/streeter/UTIL/test_proj`
- Foco pedagogico: Projeto utilitario de apoio para experimentar componentes e recursos da familia Streeter.
