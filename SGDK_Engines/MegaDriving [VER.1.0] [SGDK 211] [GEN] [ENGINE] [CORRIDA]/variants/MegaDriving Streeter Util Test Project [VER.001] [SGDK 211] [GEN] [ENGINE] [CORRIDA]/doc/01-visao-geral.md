...
`MegaDriving Streeter Util Test Project [VER.001] [SGDK 211] [GEN] [ENGINE] [CORRIDA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `../../upstream/streeter/UTIL/test_proj/src/`, `../../upstream/streeter/UTIL/test_proj/res/`, `../../upstream/streeter/UTIL/test_proj/inc/` e `../../upstream/streeter/UTIL/test_proj/out/`
...
1. Ler o `README.md`
2. Abrir `../../upstream/streeter/UTIL/test_proj/src/main.c`
