    ...
    case 1:
        {
            if (spr->AirUnit==10)
            {
                ...
                {
                    spr->TempoCouvert++;
                    if (spr->TempoCouvert==1) XGM_startPlayPCM(SFX_GENERIC12, 1, SOUND_PCM_CH4);
                    if (spr->TempoCouvert>2)
                    {
                        spr->TempoCouvert=0;
                        spr->Hit=0;
                        PAL_setPalette(PAL3, Palette_Airplane.data, DMA);
                    }
                }
                ...
                if (spr->TempoSprite>=30)
                {
                    ...
                    while(i--)
                    {
                        ...
                        if (spr1->StandBy)
                        {
                            ...
                            spr1->Hit=0;
                            XGM_startPlayPCM(SFX_GENERIC4, 1, SOUND_PCM_CH3);
...
// Bombe ?!
    case 66:
        ...
        {
            spr->TempoSprite++;
            if (spr->TempoSprite==1) XGM_startPlayPCM(SFX_GENERIC9, 1, SOUND_PCM_CH3);
            SPR_setAnim(spr->SpriteA,5);
            if (spr->TempoSprite>=30)
            {
                spr->StandBy=1;
    ...
    case 99:
        ...
        {
            spr->TempoSprite++;
            if (spr->TempoSprite==10) XGM_startPlayPCM(SFX_GENERIC13, 2, SOUND_PCM_CH4);
