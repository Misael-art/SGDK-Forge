...
void InitIntro()
{
	...
	if (!GameOver)
	{
		...
		XGM_startPlayPCM(SFX_GENERIC27, 2, SOUND_PCM_CH4);
		PAL_fadeInAll(palette,35,FALSE);
		while(TRUE)
		{
...
void InitScene()
{
	...
	SPR_setPosition(SprLvl->SpriteA,F32_toInt(SprLvl->CoordX),F32_toInt(SprLvl->CoordY));
	SPR_setAlwaysOnTop(SprLvl->SpriteA,TRUE);
	SPR_setAnim(SprLvl->SpriteA,0);
	...
	SPR_setPosition(SprHUD->SpriteA,F32_toInt(SprHUD->CoordX),F32_toInt(SprHUD->CoordY));
...
void InitRoutine()
{
	...
	// Init Scene
    XGM_setPCM(SFX_GENERIC1, Magnum_SFX, sizeof(Magnum_SFX));
    XGM_setPCM(SFX_GENERIC2, Mort_SFX, sizeof(Mort_SFX));
	XGM_setPCM(SFX_GENERIC3, Mort1_SFX, sizeof(Mort1_SFX));
	XGM_setPCM(SFX_GENERIC4, Couteau_SFX, sizeof(Couteau_SFX));
	XGM_setPCM(SFX_GENERIC5, Crunch_SFX, sizeof(Crunch_SFX));
	XGM_setPCM(SFX_GENERIC6, Aie_SFX, sizeof(Aie_SFX));
	XGM_setPCM(SFX_GENERIC7, Tank_SFX, sizeof(Tank_SFX));
	XGM_setPCM(SFX_GENERIC8, Bombe_SFX, sizeof(Bombe_SFX));
	XGM_setPCM(SFX_GENERIC9, Explosion_SFX, sizeof(Explosion_SFX));
	XGM_setPCM(SFX_GENERIC10, TirBazooka_SFX, sizeof(TirBazooka_SFX));
	XGM_setPCM(SFX_GENERIC11, Medailles_SFX, sizeof(Medailles_SFX));
	XGM_setPCM(SFX_GENERIC12, Impact_SFX, sizeof(Impact_SFX));
	XGM_setPCM(SFX_GENERIC13, Civil_SFX, sizeof(Civil_SFX));
	XGM_setPCM(SFX_GENERIC14, Bonus_SFX, sizeof(Bonus_SFX));
	XGM_setPCM(SFX_GENERIC15, Respawn_SFX, sizeof(Respawn_SFX));
	XGM_setPCM(SFX_GENERIC16, Flamethrower_SFX, sizeof(Flamethrower_SFX));
	XGM_setPCM(SFX_GENERIC17, Grenades_SFX, sizeof(Grenades_SFX));
	XGM_setPCM(SFX_GENERIC18, Health_SFX, sizeof(Health_SFX));
	XGM_setPCM(SFX_GENERIC19, HeavyMachinegun_SFX, sizeof(HeavyMachinegun_SFX));
	XGM_setPCM(SFX_GENERIC20, Machinegun_SFX, sizeof(Machinegun_SFX));
	XGM_setPCM(SFX_GENERIC21, PowerUp_SFX, sizeof(PowerUp_SFX));
	XGM_setPCM(SFX_GENERIC22, RocketLauncher_SFX, sizeof(RocketLauncher_SFX));
	XGM_setPCM(SFX_GENERIC23, Score_SFX, sizeof(Score_SFX));
	XGM_setPCM(SFX_GENERIC24, Uzi_SFX, sizeof(Uzi_SFX));
	XGM_setPCM(SFX_GENERIC25, Baby_SFX, sizeof(Baby_SFX));
	XGM_setPCM(SFX_GENERIC26, Voice_SFX, sizeof(Flamethrower_SFX));
	XGM_setPCM(SFX_GENERIC27, Logo_SFX, sizeof(Logo_SFX));
}
