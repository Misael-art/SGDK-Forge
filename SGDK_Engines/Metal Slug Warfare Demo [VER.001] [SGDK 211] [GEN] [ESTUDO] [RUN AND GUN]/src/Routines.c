...
{
    {
        ...
        {
            case 1:
            PAL_setPalette(PAL0, PaletteZone2, DMA);
            break;

            case 20:
            PAL_setPalette(PAL0, PaletteZone2_1, DMA);
            break;

            case 30:
            PAL_setPalette(PAL0, PaletteZone2_2, DMA);
            break;

            case 40:
            PAL_setPalette(PAL0, PaletteZone2_3, DMA);
            break;

            case 50:
            PAL_setPalette(PAL0, PaletteZone2_4, DMA);
            break;

            case 60:
            PAL_setPalette(PAL0, PaletteZone2_5, DMA);
            break;

            case 70:
            PAL_setPalette(PAL0, PaletteZone2_6, DMA);
            break;
...
void GestionBonus(Sprite1_ *spr)
{
    ...
    if (DistanceIA<=FIX32(24))
    {
        ...
        SpriteB->StandBy=1;
        SpriteB->Init=0;
        //XGM_startPlayPCM(SFX_GENERIC14, 2, SOUND_PCM_CH4);
        GoCivil=1;
        ...
        switch(SpriteB->Transition)
        {
            case 0:
                ...
                XGM_startPlayPCM(SFX_GENERIC17, 2, SOUND_PCM_CH4);
                break;
            ...
            case 1:
                ...
                XGM_startPlayPCM(SFX_GENERIC19, 2, SOUND_PCM_CH4);
                break;

            case 2:
                spr->HitPoint=6;
                GestionHUDSante();
                XGM_startPlayPCM(SFX_GENERIC18, 2, SOUND_PCM_CH4);
                break;

            case 3:
                Score+=250;
                GestionScore();
                XGM_startPlayPCM(SFX_GENERIC23, 2, SOUND_PCM_CH4);
                break;

            case 4:
                spr->NombreUP++;
                GestionHUDSante();
                XGM_startPlayPCM(SFX_GENERIC21, 2, SOUND_PCM_CH4);
                break;
            ...
            case 5:
                ...
                GestionNombreBallesShotgun();
                XGM_startPlayPCM(SFX_GENERIC22, 2, SOUND_PCM_CH4);
                break;
            ...
            case 6:
                ...
                GestionNombreBallesShotgun();
                XGM_startPlayPCM(SFX_GENERIC20, 2, SOUND_PCM_CH4);
                break;
            ...
            case 7:
                ...
                GestionNombreBallesShotgun();
                XGM_startPlayPCM(SFX_GENERIC16, 2, SOUND_PCM_CH4);
                break;
...
void CreateIANew(Sprite1_ *spr)
{
    ...
    if (spr->TempoRespawn>TempoRegen)
    {
        ...
        {
            if (spr->ID==6) XGM_startPlayPCM(SFX_GENERIC13, 2, SOUND_PCM_CH4);
...
void MarcheJoe(Sprite1_ *spr)
{
    ...
    s16 x = F32_toInt(SprMarcheJoe->CoordX-SprMarcheJoe->OffsetX) - CamPosX;
    s16 y = F32_toInt(SprMarcheJoe->CoordY+spr->DeltaY-spr->OffsetY) - CamPosY;
    // Affichage
...
void DisplayMedals()
{
    ...
    // on positionne le sprite relativement à la camera
    s16 x = F32_toInt(SprLvl->CoordX);
    s16 y = F32_toInt(SprLvl->CoordY);
    // Affichage
...
void GestionBombe(Sprite1_ *spr)
{
    ...
    if (spr->TempoSprite==10)
    {
        ...
        {
            XGM_startPlayPCM(SFX_GENERIC6, 1, SOUND_PCM_CH2);
        ...
        if (spr->TempoAggro>120-(Difficulte<<2))
        {
            ...
            while(i--)
            {
                ...
                if (spr1->StandBy)
                {
                    ...
                    spr1->Hit=0;
                    spr1->TempoSprite=0;
                    XGM_startPlayPCM(SFX_GENERIC8, 1, SOUND_PCM_CH3);
...
void Result_Screen()
{
	...
	SPR_setPriorityAttribut(spr->SpriteA, TRUE);
	SPR_setVisibility(spr->SpriteA,VISIBLE);
	SPR_setPosition(spr->SpriteA,F32_toInt(spr->CoordX),F32_toInt(spr->CoordY));
    ...
    PAL_fadeInAll(palette,32,FALSE);
    // update sprites
    SPR_update();
	...
	while(TRUE)
	{
        ...
        SPR_setPosition(HighScoreTexte->SpriteA,F32_toInt(HighScoreTexte->CoordX),F32_toInt(HighScoreTexte->CoordY));
        i=5;
        j=0;
        scoHigh=&HighScore[0];
        PosX+=4;
...
void Phase_Scene(u8 Scene,Sprite1_ *spr)
{
    ...
    case 1:
        if (spr->CoordX<FIX32(80))
        {
            ...
            {
                spr->Init=1;
                XGM_startPlayPCM(SFX_GENERIC7, 1, SOUND_PCM_CH2);
            }
        }
        if (spr->CoordX>=FIX32(80))
        {
            ...
            SprMarco->SensY=1;
            XGM_startPlayPCM(SFX_GENERIC4, 1, SOUND_PCM_CH2);
        }
    ...
    case 3:
        ...
        if (spr->CoordX>=FIX32(200) &&  PhaseAffichageScene==2)
        {
            ...
            XGM_startPlayPCM(SFX_GENERIC9, 1, SOUND_PCM_CH3);
            XGM_startPlayPCM(SFX_GENERIC25, 2, SOUND_PCM_CH4);
            TremblementON=1;
            TempoMax=8;
            TempoTremblement=0;
        }
                ...
                case 6:
                    if (spr->CoordX<(SprIA->CoordX))
                    {
                        if (DX_IA<=FIX32(48))
                        {
                            ...
                            SprIA->TempoSprite=0;
                            GestionScore();
                            if (SND_isPlayingPCM_XGM(SOUND_PCM_CH2)) XGM_startPlayPCM(SFX_GENERIC5, 1, SOUND_PCM_CH2);
                            return;
                        }
                    }
...
void GestionScore()
{
    ...
    if (Score>=750 && Score<=1500 && !Difficulte)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        if (!Difficulte)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=1;
    }
    if (Score>1500 && Score<=2250 && Difficulte==1)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==1)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=2;
    }
    if (Score>2250 && Score<=3000 && Difficulte==2)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==2)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=3;
    }
    if (Score>3000 && Score<=4000 && Difficulte==3)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==3)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=4;
    }
    if (Score>4000 && Score<=5250 && Difficulte==4)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==4)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=5;
    }
    if (Score>5250 && Difficulte==5 && Score<=6500)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==5)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=6;
    }
    if (Score>6500 && Difficulte==6 && Score<=7750)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==6)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=7;
    }
    if (Score>7750 && Difficulte==7 && Score<=9000)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==7)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=8;
    }
    if (Score>9000 && Difficulte==8 && Score<=10500)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==8)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=9;
    }
    if (Score>10500 && Difficulte==9)
    {
        ...
        SPR_setVisibility(SprLvl->SpriteA,VISIBLE);
        ApparitionMedailles=1;
        if (Difficulte==9)  XGM_startPlayPCM(SFX_GENERIC11, 1, SOUND_PCM_CH4);
        Difficulte=10;
    }
...
void GestionGrenades(Sprite1_ *spr)
{
    ...
    if (SprIA->Phase==2 && !SprIA->Hit && !spr->Hit)
    {
        ...
        if (DX_IA<=C && DY_IA<=FIX32(24) && !SprIA->MortIA)
        {
            ...
            PAL_setPalette(PAL3, BlankPalette, DMA);
            SprIA->Hit=1;
            return;
        }
    }
    ...
    if (!SprIA->StandBy && !SprIA->MortIA && SprIA->ID!=6)
    {
        ...
        if (DX_IA<=FIX32(26) && DY_IA<=FIX32(24) && !TES)
        {
            ...
            if (!SprIA->HitPoint)
            {
                ...
                {
                    if (getRandomU16(100)<50) XGM_startPlayPCM(SFX_GENERIC2, 1, SOUND_PCM_CH2);
                    else XGM_startPlayPCM(SFX_GENERIC3, 1, SOUND_PCM_CH2);
                }
                return;
            }
            else
...
void BallesIATest(Sprite1_ *spr1, Sprite1_ *spr)
{
    ...
    if (spr->AirUnit==10)
    {
        ...
        if (spr->Direction==4)
        {
            ...
            XGM_startPlayPCM(SFX_GENERIC10, 1, SOUND_PCM_CH2);
        }
        else
        {
            spr1->Direction=16;
    ...
    else
    {
        ...
        {
            XGM_startPlayPCM(SFX_GENERIC1, 1, SOUND_PCM_CH2);
        ...
        if (spr->ID==6)
        {
            ...
            if (spr->MortIA==20)
            {
                ...
                if (spr->TempoSprite==35)
                {
                    ...
                    SpriteB->Visible=1;
                    XGM_startPlayPCM(SFX_GENERIC15, 2, SOUND_PCM_CH4);
                    SpriteB->StandBy=0;
                ...
                if (spr->TempoSprite==2) XGM_startPlayPCM(SFX_GENERIC13, 2, SOUND_PCM_CH4);
...
void updateCameraPosition(Sprite1_ *spr)
{
    ...
    s16 px = F32_toInt(posX);
    s16 py = F32_toInt(posY);
...
void DisplaySprite(Sprite1_ *spr)
{
    ...
    // on positionne le sprite relativement à la camera
    s16 x = F32_toInt(spr->CoordX-spr->OffsetX) - CamPosX;
    s16 y = F32_toInt(spr->CoordY+spr->DeltaY-spr->OffsetY) - CamPosY;
...
{
    sprintf(Texte,"D :%ld",F32_toInt(D));
...
void Zone3()
{
    ...
    // Données Textes / FONT
	PAL_fadeInAll(palette,24,FALSE);
	...
	while(TRUE)
	{
        ...
        switch (PhaseScene)
        {
            ...
            if (spr->TempoSprite>100)
            {
                ...
                Tempo=0;
                j=0;
                XGM_startPlayPCM(SFX_GENERIC26, 2, SOUND_PCM_CH4);
            }
            break;
		...
		if (PhaseJoueur)
        {
            ...
            {
                spr->Feu=1;
                XGM_startPlayPCM(SFX_GENERIC10, 1, SOUND_PCM_CH3);
            }
        ...
        while(i--)
        {
            ...
            SPR_setPosition(spr->SpriteA,F32_toInt(spr->CoordX-spr->OffsetX),F32_toInt(spr->CoordY));
            spr++;
        }
