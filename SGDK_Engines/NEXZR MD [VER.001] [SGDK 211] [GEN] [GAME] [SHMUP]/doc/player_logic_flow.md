# Player Logic Flow - NEXZR MD [VER.001] [SGDK 211] [GEN] [GAME] [SHMUP]

This document describes the player control flow and state management for the NEXZR MD [VER.001] [SGDK 211] [GEN] [GAME] [SHMUP].
