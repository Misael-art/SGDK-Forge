...
#define FIX16(a)           _Pragma("GCC error \"This method is deprecated, use FIX16(..) instead.\"")
#define F16_toInt(a)           _Pragma("GCC error \"This method is deprecated, use F16_toInt(..) instead.\"")
#define F16_toFix32(a)         _Pragma("GCC error \"This method is deprecated, use F16_toFix32(..) instead.\"")
#define F16_frac(a)            _Pragma("GCC error \"This method is deprecated, use F16_frac(..) instead.\"")
#define F16_int(a)             _Pragma("GCC error \"This method is deprecated, use F16_int(..) instead.\"")
#define F16_round(a)           _Pragma("GCC error \"This method is deprecated, use F16_round(..) instead.\"")
#define F16_toRoundedInt(a)    _Pragma("GCC error \"This method is deprecated, use F16_toRoundedInt(..) instead.\"")
#define ((a) + (b))          _Pragma("GCC error \"This method is deprecated, simply use '+' operator to add fix16 values together.\"")
#define ((a) - (b))          _Pragma("GCC error \"This method is deprecated, simply use '-' operator to subtract fix16 values.\"")
#define (0 - (a))             _Pragma("GCC error \"This method is deprecated, simply use '0 - value' to get the negative fix16 value.\"")
#define F16_mul(a, b)          _Pragma("GCC error \"This method is deprecated, use F16_mul(..) instead.\"")
#define F16_div(a, b)          _Pragma("GCC error \"This method is deprecated, use F16_div(..) instead.\"")
#define F16_avg(a, b)          _Pragma("GCC error \"This method is deprecated, use F16_avg(..) instead.\"")
#define F16_log2(a)            _Pragma("GCC error \"This method is deprecated, use F16_log2(..) instead.\"")
#define F16_log10(a)           _Pragma("GCC error \"This method is deprecated, use F16_log10(..) instead.\"")
#define F16_sqrt(a)            _Pragma("GCC error \"This method is deprecated, use F16_sqrt(..) instead.\"")
...
// Deprecated functions
#define FIX32(a)           _Pragma("GCC error \"This method is deprecated, use FIX32(..) instead.\"")
#define F32_toInt(a)           _Pragma("GCC error \"This method is deprecated, use F32_toInt(..) instead.\"")
#define F32_toFix16(a)         _Pragma("GCC error \"This method is deprecated, use F32_toFix16(..) instead.\"")
#define F32_frac(a)            _Pragma("GCC error \"This method is deprecated, use F32_frac(..) instead.\"")
#define F32_int(a)             _Pragma("GCC error \"This method is deprecated, use F32_int(..) instead.\"")
#define F32_round(a)           _Pragma("GCC error \"This method is deprecated, use F32_round(..) instead.\"")
#define F32_toRoundedInt(a)    _Pragma("GCC error \"This method is deprecated, use F32_toRoundedInt(..) instead.\"")
...
#define F32_mul(a, b)          _Pragma("GCC error \"This method is deprecated, use F32_mul(..) instead.\"")
#define F32_div(a, b)          _Pragma("GCC error \"This method is deprecated, use F32_div(..) instead.\"")
