 ...
 */
#define PAL_setColors(index, pal, count, DMA)     _Pragma("GCC error \"This method is deprecated, use PAL_setColors(..) instead.\"")
/**
 *  \deprecated
 ...
 */
#define PAL_setPalette(numPal, pal, DMA)          _Pragma("GCC error \"This method is deprecated, use PAL_setPalette(..) instead.\"")
