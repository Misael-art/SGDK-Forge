 ...
 */
#define XGM_startPlay(song)     _Pragma("GCC error \"This method is deprecated, use XGM_startPlay(..) instead.\"")
/**
 * \deprecated use XGM_stopPlay(..) instead
 */
#define XGM_stopPlay()          _Pragma("GCC error \"This method is deprecated, use XGM_stopPlay() instead.\"")
/**
 * \deprecated use XGM_pausePlay(..) instead
 */
#define XGM_pausePlay()         _Pragma("GCC error \"This method is deprecated, use XGM_pausePlay() instead.\"")
/**
 * \deprecated use XGM_resumePlay(..) instead
 */
#define XGM_resumePlay()        _Pragma("GCC error \"This method is deprecated, use XGM_resumePlay() instead.\"")
 ...
 */
#define XGM_setPCM(id, sample, len)     _Pragma("GCC error \"This method is deprecated, use XGM_setPCM(..) instead.\"")
/**
 * \deprecated use XGM_setPCMFast(..) instead
 */
#define XGM_setPCMFast(id, sample, len) _Pragma("GCC error \"This method is deprecated, use XGM_setPCMFast(..) instead.\"")
/**
 * \deprecated use XGM_startPlayPCM(..) instead
 */
#define XGM_startPlayPCM(id, prio, ch)  _Pragma("GCC error \"This method is deprecated, use XGM_startPlayPCM(..) instead.\"")
/**
 * \deprecated use XGM_stopPlayPCM(..) instead
 */
#define XGM_stopPlayPCM(channel)        _Pragma("GCC error \"This method is deprecated, use XGM_stopPlayPCM(..) instead.\"")
