# Engine Architecture Nodes - Opeth Music Cartridge [VER.001] [SGDK 211] [GEN] [ESTUDO] [AUDIO]

Overview of the technical structure of the Opeth Music Cartridge [VER.001] [SGDK 211] [GEN] [ESTUDO] [AUDIO] engine.

## 1. Modular Structure
The engine is composed of the following core modules:
- **`main.c`**: Entry point and primary game loop.
- **`konami_code.c`**: Module file.
- **`log_tab.c`**: Module file.
- **`psg_state.c`**: Module file.
- **`screen_state.c`**: Module file.
- **`tracklist.c`**: Module file.
- **`xgm_tool.c`**: Module file.
- **`ym_state.c`**: Module file.
