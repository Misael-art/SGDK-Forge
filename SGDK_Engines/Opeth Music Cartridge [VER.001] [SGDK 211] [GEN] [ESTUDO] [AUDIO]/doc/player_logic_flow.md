# Player Logic Flow - Opeth Music Cartridge [VER.001] [SGDK 211] [GEN] [ESTUDO] [AUDIO]

This document describes the player control flow and state management for the Opeth Music Cartridge [VER.001] [SGDK 211] [GEN] [ESTUDO] [AUDIO].
...
```ascii
    [ START ] --> [ INIT ]
              ...
              [ STATE MACHINE ]
                     |
       STATE_PLAYER -> STATE_INFO -> STATE_MENU -> STATE_LOGO
                     |
