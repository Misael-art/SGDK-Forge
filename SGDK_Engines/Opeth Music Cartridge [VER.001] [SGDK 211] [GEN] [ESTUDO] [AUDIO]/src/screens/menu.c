...
void menuScreen(){
    ...
    */
    ...
    VDP_drawImageEx(WINDOW, &opeth_img, TILE_ATTR_FULL(PAL1, TRUE, FALSE, FALSE, TILE_USER_INDEX), 0, 0, FALSE, TRUE);
    ...
    while(currentState == STATE_MENU){
        ...
        if (konami_triggered) {
            ...
            VDP_clearPlane(WINDOW, TRUE);
            VDP_drawImageEx(BG_B, &mikael_img, TILE_ATTR_FULL( PAL1, TRUE, FALSE, FALSE, TILE_USER_INDEX), 8, 1, FALSE, TRUE);
