# Player Logic Flow - Plane Scroll Basics [VER.001] [SGDK 211] [GEN] [ESTUDO] [SCROLL]

This document describes the player control flow and state management for the Plane Scroll Basics [VER.001] [SGDK 211] [GEN] [ESTUDO] [SCROLL].
