# Engine Architecture Nodes - Platformer 2 [VER.001] [SGDK 211] [GEN] [ESTUDO] [PLATAFORMA]

Overview of the technical structure of the Platformer 2 [VER.001] [SGDK 211] [GEN] [ESTUDO] [PLATAFORMA] engine.
...
readInput, while, if, update_physics, inputHandle, main
