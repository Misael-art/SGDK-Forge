# Player Logic Flow - Platformer 2 [VER.001] [SGDK 211] [GEN] [ESTUDO] [PLATAFORMA]

This document describes the player control flow and state management for the Platformer 2 [VER.001] [SGDK 211] [GEN] [ESTUDO] [PLATAFORMA].
...
The project uses active input handlers: inputHandle
