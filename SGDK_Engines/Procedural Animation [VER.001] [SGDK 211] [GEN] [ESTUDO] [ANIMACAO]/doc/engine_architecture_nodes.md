# Engine Architecture Nodes - Procedural Animation [VER.001] [SGDK 211] [GEN] [ESTUDO] [ANIMACAO]

Overview of the technical structure of the Procedural Animation [VER.001] [SGDK 211] [GEN] [ESTUDO] [ANIMACAO] engine.
...
while, main, if, gameOver, initSoundFX, for, initGame
