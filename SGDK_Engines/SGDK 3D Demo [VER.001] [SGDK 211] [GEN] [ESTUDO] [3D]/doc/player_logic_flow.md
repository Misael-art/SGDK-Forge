# Player Logic Flow - SGDK 3D Demo [VER.001] [SGDK 211] [GEN] [ESTUDO] [3D]

This document describes the player control flow and state management for the SGDK 3D Demo [VER.001] [SGDK 211] [GEN] [ESTUDO] [3D].
