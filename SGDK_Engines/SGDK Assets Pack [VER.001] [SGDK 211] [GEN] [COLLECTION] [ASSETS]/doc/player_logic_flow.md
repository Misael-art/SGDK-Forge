# Player Logic Flow - SGDK Assets Pack [VER.001] [SGDK 211] [GEN] [COLLECTION] [ASSETS]

This document describes the player control flow and state management for the SGDK Assets Pack [VER.001] [SGDK 211] [GEN] [COLLECTION] [ASSETS].
