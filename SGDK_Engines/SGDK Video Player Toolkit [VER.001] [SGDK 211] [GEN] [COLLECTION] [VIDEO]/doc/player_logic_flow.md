# Player Logic Flow - SGDK Video Player Toolkit [VER.001] [SGDK 211] [GEN] [COLLECTION] [VIDEO]

This document describes the player control flow and state management for the SGDK Video Player Toolkit [VER.001] [SGDK 211] [GEN] [COLLECTION] [VIDEO].
