# Scroll Vertical 976 [VER.001] [SGDK 211] [GEN] [ESTUDO] [SCROLL]
...
**SGDK root real** fica em `Scroll Vertical976`.
...
projeto/
  ...
  Scroll Vertical976/          # SGDK root real
...
- Edite codigo e recursos dentro de `Scroll Vertical976/`.
...
2. Abra `Scroll Vertical976/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
