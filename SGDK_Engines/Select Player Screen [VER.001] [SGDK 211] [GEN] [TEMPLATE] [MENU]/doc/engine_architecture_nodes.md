# Engine Architecture Nodes - Select Player Screen [VER.001] [SGDK 211] [GEN] [TEMPLATE] [MENU]

Overview of the technical structure of the Select Player Screen [VER.001] [SGDK 211] [GEN] [TEMPLATE] [MENU] engine.
...
moveDown, switch, handleInputKnuckles, while, knuckles_player, joyEventHandlerMenu, handleInputSonic, carregarFase, if, select
