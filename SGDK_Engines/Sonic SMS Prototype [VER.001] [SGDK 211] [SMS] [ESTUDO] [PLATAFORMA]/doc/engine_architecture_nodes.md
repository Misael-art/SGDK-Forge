# Engine Architecture Nodes - Sonic SMS Prototype [VER.001] [SGDK 211] [SMS] [ESTUDO] [PLATAFORMA]

Overview of the technical structure of the Sonic SMS Prototype [VER.001] [SGDK 211] [SMS] [ESTUDO] [PLATAFORMA] engine.
...
updateAnim, joyEvent, while, updateCamera, updatePhysic, if, handleInput, updateMap, main
