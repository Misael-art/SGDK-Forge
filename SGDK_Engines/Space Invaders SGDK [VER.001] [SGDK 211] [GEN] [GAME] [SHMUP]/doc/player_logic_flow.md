# Player Logic Flow - Space Invaders SGDK [VER.001] [SGDK 211] [GEN] [GAME] [SHMUP]

This document describes the player control flow and state management for the Space Invaders SGDK [VER.001] [SGDK 211] [GEN] [GAME] [SHMUP].
