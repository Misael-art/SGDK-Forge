# Player Logic Flow - Super Monaco GP [VER.001] [SGDK 211] [GEN] [GAME] [CORRIDA]

This document describes the player control flow and state management for the Super Monaco GP [VER.001] [SGDK 211] [GEN] [GAME] [CORRIDA].
