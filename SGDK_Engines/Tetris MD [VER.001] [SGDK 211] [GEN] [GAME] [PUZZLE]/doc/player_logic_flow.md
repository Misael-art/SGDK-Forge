# Player Logic Flow - Tetris MD [VER.001] [SGDK 211] [GEN] [GAME] [PUZZLE]

This document describes the player control flow and state management for the Tetris MD [VER.001] [SGDK 211] [GEN] [GAME] [PUZZLE].
...
```ascii
    [ START ] --> [ INIT ]
              ...
              [ STATE MACHINE ]
                     |
       GAME_OPTION -> IDLE -> CLEARING -> REBORN -> 4
                     |
...
The project uses active input handlers: joyEventOnGameTitle, joyEventOnGameOption, joyEventOnGamePlay, joyEventOnNoControl, joyEventOnGameOver
