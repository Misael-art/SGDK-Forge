# Engine Architecture Nodes - TidyText [VER.001] [SGDK 211] [GEN] [TEMPLATE] [TEXTO]

Overview of the technical structure of the TidyText [VER.001] [SGDK 211] [GEN] [TEMPLATE] [TEXTO] engine.

## 1. Modular Structure
The engine is composed of the following core modules:
- **`main.c`**: Entry point and primary game loop.
- **`rom_header.c`**: Module file.
- **`tidyText.c`**: Module file.
