# Player Logic Flow - Tile Scroll Basics [VER.001] [SGDK 211] [GEN] [ESTUDO] [SCROLL]

This document describes the player control flow and state management for the Tile Scroll Basics [VER.001] [SGDK 211] [GEN] [ESTUDO] [SCROLL].
