# Engine Architecture Nodes - Town Quest [VER.001] [SGDK 211] [GEN] [GAME] [RPG]

Overview of the technical structure of the Town Quest [VER.001] [SGDK 211] [GEN] [GAME] [RPG] engine.
...
init_stage, handlestate, handleinput, run_stage, while, init_game_data, if, readcontrollers, updatephisycs, removeAllSprites
