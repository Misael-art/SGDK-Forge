# Player Logic Flow - Town Quest [VER.001] [SGDK 211] [GEN] [GAME] [RPG]

This document describes the player control flow and state management for the Town Quest [VER.001] [SGDK 211] [GEN] [GAME] [RPG].
