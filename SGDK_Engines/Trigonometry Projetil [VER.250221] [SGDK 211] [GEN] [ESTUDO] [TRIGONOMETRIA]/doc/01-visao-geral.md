...
`Trigonometry Projetil [VER.250221] [SGDK 211] [GEN] [ESTUDO] [TRIGONOMETRIA]` segue o worktree canônico do MegaDrive_DEV.
...
- O SGDK root e o ponto de entrada tecnico: `src/`, `res/`, `inc/` e `out/`
