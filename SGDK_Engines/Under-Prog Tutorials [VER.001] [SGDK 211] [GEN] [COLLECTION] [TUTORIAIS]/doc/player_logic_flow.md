# Player Logic Flow - Under-Prog Tutorials [VER.001] [SGDK 211] [GEN] [COLLECTION] [TUTORIAIS]

This document describes the player control flow and state management for the Under-Prog Tutorials [VER.001] [SGDK 211] [GEN] [COLLECTION] [TUTORIAIS].
