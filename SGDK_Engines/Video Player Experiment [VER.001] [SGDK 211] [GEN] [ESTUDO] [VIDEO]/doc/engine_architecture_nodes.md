# Engine Architecture Nodes - Video Player Experiment [VER.001] [SGDK 211] [GEN] [ESTUDO] [VIDEO]

Overview of the technical structure of the Video Player Experiment [VER.001] [SGDK 211] [GEN] [ESTUDO] [VIDEO] engine.

## 1. Modular Structure
The engine is composed of the following core modules:
- **`main.c`**: Entry point and primary game loop.
- **`movie_player.c`**: Module file.
