# Player Logic Flow - XGM2 Driver Samples [VER.001] [SGDK 211] [GEN] [COLLECTION] [AUDIO]

This document describes the player control flow and state management for the XGM2 Driver Samples [VER.001] [SGDK 211] [GEN] [COLLECTION] [AUDIO].
