...
// Este sample funciona como um laboratorio interativo para os drivers de audio do SGDK.
// O usuario navega pelos drivers e parametros com o controle e ouve o resultado em tempo real.
#define NUM_DRIVER      6
#define MAX_CMD         8
#define MAX_PARAM       16
...
// Cada entrada descreve um driver disponivel e quais comandos a interface vai oferecer.
...
// Aqui so acontece o setup da ferramenta.
// A logica de navegacao fica nos callbacks de controle e VBlank declarados acima.
int main()
{
    u16 i, j;
    ...
    // Todo comando comeca apontando para o primeiro parametro disponivel da tabela.
