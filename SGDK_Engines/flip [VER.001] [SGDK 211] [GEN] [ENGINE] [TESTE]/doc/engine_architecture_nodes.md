# Engine Architecture Nodes - flip [VER.001] [SGDK 211] [GEN] [ENGINE] [TESTE]

Overview of the technical structure of the flip [VER.001] [SGDK 211] [GEN] [ENGINE] [TESTE] engine.
...
flipHTilemap, flipVTilemap, while, if, for, main, flipVHTilemap
