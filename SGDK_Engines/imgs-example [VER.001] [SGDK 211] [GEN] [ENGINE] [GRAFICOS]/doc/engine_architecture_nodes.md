# Engine Architecture Nodes - imgs-example [VER.001] [SGDK 211] [GEN] [ENGINE] [GRAFICOS]

Overview of the technical structure of the imgs-example [VER.001] [SGDK 211] [GEN] [ENGINE] [GRAFICOS] engine.
...
main, while, reset_hero, draw_scene
