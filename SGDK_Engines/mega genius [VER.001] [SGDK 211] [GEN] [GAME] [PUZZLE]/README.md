# mega genius [VER.001] [SGDK 211] [GEN] [GAME] [PUZZLE]
...
**SGDK root real** fica em `mega genius`.
...
- Edite codigo e recursos dentro de `mega genius/`.
