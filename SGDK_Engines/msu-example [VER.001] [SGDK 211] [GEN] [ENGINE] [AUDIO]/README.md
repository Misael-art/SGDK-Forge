# msu-example [VER.001] [SGDK 211] [GEN] [ENGINE] [AUDIO]
...
**SGDK root real** fica em `msu-example`.
...
- Edite codigo e recursos dentro de `msu-example/`.
