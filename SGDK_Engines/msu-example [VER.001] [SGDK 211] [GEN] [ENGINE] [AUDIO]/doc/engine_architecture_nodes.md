# Engine Architecture Nodes - msu-example [VER.001] [SGDK 211] [GEN] [ENGINE] [AUDIO]

Overview of the technical structure of the msu-example [VER.001] [SGDK 211] [GEN] [ENGINE] [AUDIO] engine.
