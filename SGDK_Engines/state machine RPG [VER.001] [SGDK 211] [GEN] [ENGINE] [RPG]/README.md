# state machine RPG [VER.001] [SGDK 211] [GEN] [ENGINE] [RPG]
...
**SGDK root real** fica em `state_machine`.
...
- Edite codigo e recursos dentro de `state_machine/`.
...
2. Abra `state_machine/src/main.c`.
3. Rode `build.bat`.
4. Rode `run.bat`.
