# Engine Architecture Nodes - state machine RPG [VER.001] [SGDK 211] [GEN] [ENGINE] [RPG]

Overview of the technical structure of the state machine RPG [VER.001] [SGDK 211] [GEN] [ENGINE] [RPG] engine.
