# Player Logic Flow - state machine RPG [VER.001] [SGDK 211] [GEN] [ENGINE] [RPG]

This document describes the player control flow and state management for the state machine RPG [VER.001] [SGDK 211] [GEN] [ENGINE] [RPG].
