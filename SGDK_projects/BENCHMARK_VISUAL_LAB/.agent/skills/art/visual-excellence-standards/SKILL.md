...
description: Use quando a tarefa pedir julgamento estetico, legibilidade, contraste entre planos, dithering, eficiencia perceptiva de paleta ou canonizacao de feedback visual para assets Mega Drive. Esta skill trata arte como recurso de VDP com barra AAA e memoria acumulada. Nao use para diagnosticar qual cenario de arte o projeto possui, converter tecnicamente assets ja aprovados para o pipeline, buscar assets externos ou validar restricoes pixel-rigidas sem contexto estetico.
---
