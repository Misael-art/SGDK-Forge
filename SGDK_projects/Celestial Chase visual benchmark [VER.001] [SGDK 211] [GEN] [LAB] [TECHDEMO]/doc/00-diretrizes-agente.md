...
| Metrica | Valor |
|---|---|
| Simbolos visuais no `.res` | 21 |
| Rastreados a builder de primitivas | **20** |
...
Simbolos escritos por builder de primitivas (20) — nenhum pode ser `final`:
...
- `img_chase_bg_b_v011` <- build_chase_first_playable_assets.py
- `img_chase_bg_a_v011` <- build_chase_first_playable_assets.py
- `ts_chase_letterbox_v009` <- build_chase_first_playable_assets.py
- `ts_chase_hud_font_v011` <- build_chase_first_playable_assets.py
- `spr_chase_cloud_v009` <- build_chase_first_playable_assets.py
- `spr_chase_hero_run_v009` <- build_chase_first_playable_assets.py
- `spr_chase_hero_ghost_v009` <- build_chase_first_playable_assets.py
- `spr_chase_pursuer_torso_v011` <- build_chase_first_playable_assets.py
- `spr_chase_pursuer_head_v009` <- build_chase_first_playable_assets.py
- `spr_chase_pursuer_claw_v009` <- build_chase_first_playable_assets.py
- `spr_chase_obstacle_boulder_v011` <- build_chase_first_playable_assets.py
- `spr_chase_obstacle_brand_v011` <- build_chase_first_playable_assets.py
- `spr_chase_contact_shadow_v011` <- build_chase_first_playable_assets.py
- `spr_chase_energy_star_v009` <- build_chase_first_playable_assets.py
- `spr_chase_pulse_impact_v009` <- build_chase_first_playable_assets.py
...
- `sprite_pressure_unmeasured` (prosa, nada computavel): **1**

Declaracoes que pedem acao:

- `scene-contracts.json` -> `scanline_sprite_pressure` = "nao_medido" (sem numero) -> `sprite_pressure_unmeasured`
- `scene-contracts.json` -> `scanline_sprite_pressure` = "runtime v012 observado 9/20; enumerador ligado a geometr" (45%) -> `unexploited_headroom`
