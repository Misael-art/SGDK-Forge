...
2. Renomeie o diretorio conforme o documento do workspace `doc/PADRAO_NOMENCLATURA.md` e substitua `FORGE_REFERENCE [VER.001] [SGDK 211] [GEN] [LAB] [TECHDEMO]` nos documentos e em [`.mddev/project.json`](./.mddev/project.json).
