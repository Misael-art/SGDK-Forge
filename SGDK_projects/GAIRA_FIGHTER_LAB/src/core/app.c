...
#include "scenes/scene_char_design.h"
...
void APP_boot(bool hardReset)
{
    ...
    gApp.currentScene = APP_SCENE_MENU;
    gApp.previousScene = APP_SCENE_MENU;
    gApp.totalFrames = 0;
    gApp.sceneFrames = 0;
...
void APP_update(void)
{
    ...
    if (gApp.sceneNeedsEnter)
    {
        switch (gApp.currentScene)
        {
            ...
            case APP_SCENE_CHAR_DESIGN: SCENE_charDesignEnter(); break;
            case APP_SCENE_MULTIPLANE: SCENE_multiplaneEnter(); break;
            default: SCENE_menuEnter(); break;
        }
    ...
    switch (gApp.currentScene)
    {
        ...
        case APP_SCENE_CHAR_DESIGN: SCENE_charDesignUpdate(); break;
        case APP_SCENE_MULTIPLANE: SCENE_multiplaneUpdate(); break;
        default: SCENE_menuUpdate(); break;
    }
