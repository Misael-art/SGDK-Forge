...
- o nome real do diretorio, `.mddev/project.json` e `project_methodology_manifest.json` devem permanecer coerentes com o documento do workspace `doc/PADRAO_NOMENCLATURA.md`, sem `GOTHAM_OVERDRIVE [VER.001] [SGDK 211] [GEN] [LAB] [TECHDEMO]`;
...
- `img_gotham_skyline_bgb` <- build_gotham_overdrive_assets.py
- `img_gotham_roadway_bga` <- build_gotham_overdrive_assets.py
- `spr_batmobile` <- build_gotham_overdrive_assets.py
- `spr_boss_chassis` <- build_gotham_overdrive_assets.py
- `spr_boss_turret` <- build_gotham_overdrive_assets.py
- `spr_boss_tread_left` <- build_gotham_overdrive_assets.py
- `spr_boss_tread_right` <- build_gotham_overdrive_assets.py
- `spr_boss_missile_pod` <- build_gotham_overdrive_assets.py
- `spr_drone` <- build_gotham_overdrive_assets.py
- `spr_projectiles` <- build_gotham_overdrive_assets.py
- `spr_particles` <- build_gotham_overdrive_assets.py
