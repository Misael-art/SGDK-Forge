# Agent Learning - HAMOOPIG [VER.001] [SGDK 211] [GEN] [ENGINE] [FIGHTING]
...
2b. se a tarefa for roster, lutador grande, Musgo, Ken ou seletor, leia
   `musgo_roster_lessons.md` (caderno medido 2026-09-11);
