...
u8   gSombraStyle=1;
bool gDebug = 0;
u16  gDebugFlags = DBG_DEFAULT;
bool gRegionIsPal = FALSE;
u8   gLogicRate = LOGIC_RATE_60;
u8   gTimingProfile = TIMING_PROFILE_NORMAL;
u8   gSubTick = 0;
bool gScreen240 = FALSE;
bool gFreeStepArmed = FALSE;
bool gFreeStepAdvance = FALSE;
char gStr[64];
u16  gInd_tileset;
bool gASG_system;
u8   gPing2 = 0;
