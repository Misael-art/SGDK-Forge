...
2. Renomeie o diretorio conforme o documento do workspace `doc/PADRAO_NOMENCLATURA.md` e substitua `KIRBY_FAN GAME CLOUDE [VER.001] [SGDK 211] [GEN] [GAME] [ACTION_PLATFORMER]` nos documentos e em [`.mddev/project.json`](./.mddev/project.json).
