...
2. Renomeie o diretorio conforme o documento do workspace `doc/PADRAO_NOMENCLATURA.md` e substitua `MARE_BRAVA [VER.001] [SGDK 211] [GEN] [GAME] [BRAWLER]` nos documentos e em [`.mddev/project.json`](./.mddev/project.json).
