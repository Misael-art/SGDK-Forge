...
- o nome real do diretorio, `.mddev/project.json` e `project_methodology_manifest.json` devem permanecer coerentes com o documento do workspace `doc/PADRAO_NOMENCLATURA.md`, sem `MARE_BRAVA [VER.001] [SGDK 211] [GEN] [GAME] [BRAWLER]`;
...
- `scene-contracts.json` -> `scanline_sprite_pressure` = "nao_medido (risco declarado: 4 inimigos na mesma faixa d" (sem numero) -> `sprite_pressure_unmeasured`
