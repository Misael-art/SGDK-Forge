...
2. Renomeie o diretorio conforme o documento do workspace `doc/PADRAO_NOMENCLATURA.md` e substitua `Mugenesis_Demo [VER.001] [SGDK 211] [GEN] [GAME] [FIGHTING]` nos documentos e em [`.mddev/project.json`](./.mddev/project.json).
