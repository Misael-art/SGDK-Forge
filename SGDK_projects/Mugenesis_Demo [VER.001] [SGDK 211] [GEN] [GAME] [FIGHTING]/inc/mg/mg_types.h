/* COPIADO de tools/mugen2sgdk_forge/runtime/mg_types.h (v0.3.0). Edite na fonte. */
...
typedef struct {
    ...
    const SpriteDefinition *shadow;/* sombra 32x8 pontilhada (silhueta 0,0 achatada) ou 0 */
} MgCharDef;
