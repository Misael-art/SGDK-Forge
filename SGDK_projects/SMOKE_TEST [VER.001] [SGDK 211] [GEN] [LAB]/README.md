...
6. Preencha `doc/14-plano-de-provas-qa.md` com a rota minima para provar visual, audio e hardware real.
7. Coloque assets brutos em `res/data/`.
8. Edite o codigo em `src/` e `inc/`.
9. Rode `build.bat` no Windows ou `../../tools/sgdk_wrapper/build.sh "$PWD"` em shell POSIX.
