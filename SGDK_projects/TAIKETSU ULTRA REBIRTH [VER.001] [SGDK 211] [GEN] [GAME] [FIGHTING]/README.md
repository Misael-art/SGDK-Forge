# TAIKETSU ULTRA REBIRTH

Fighting 2D autoral para Mega Drive / SGDK 2.11, produzido em degraus D0-D6.

## Creditos e referencia

Jack e Ryo partem da engine HAMOOPIG de GameDevBoss / Daniel Moura. O projeto preserva os creditos exigidos pela licenca e mantem a referencia local em `rascunho/engine_reference/taiketsu_ultra_hero_genesis/`. A referencia de geracao e tecnica, nao uma autorizacao para copiar personagens, identidade ou arte fora do escopo declarado.

O projeto ainda nao declara `ready_for_aaa`: a medicao do workspace esta em 17/18 ate `validate_native_sprite_production.py` possuir self-check.
...
2. Renomeie o diretorio conforme o documento do workspace `doc/PADRAO_NOMENCLATURA.md` e substitua `TAIKETSU ULTRA REBIRTH [VER.001] [SGDK 211] [GEN] [GAME] [FIGHTING]` nos documentos e em [`.mddev/project.json`](./.mddev/project.json).
