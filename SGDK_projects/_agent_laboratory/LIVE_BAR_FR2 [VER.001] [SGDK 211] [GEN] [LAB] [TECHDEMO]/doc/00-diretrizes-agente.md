...
| Metrica | Valor |
|---|---|
| Simbolos visuais no `.res` | 4 |
| Rastreados a builder de primitivas | **3** |
| Proveniencia declarada | 0 |
| Manifesto de proveniencia | `invalid` |
| Veredito | **BLOCKED** |

Blockers ativos:

- `asset_provenance_manifest_invalid`
- `asset_provenance_undeclared`
- `procedural_asset_promoted_to_res`

Simbolos escritos por builder de primitivas (3) — nenhum pode ser `final`:

- `img_dock` <- build_lineart_blocking_1px.py
- `spr_hero` <- build_lineart_blocking_1px.py
- `spr_thug` <- build_lineart_blocking_1px.py
