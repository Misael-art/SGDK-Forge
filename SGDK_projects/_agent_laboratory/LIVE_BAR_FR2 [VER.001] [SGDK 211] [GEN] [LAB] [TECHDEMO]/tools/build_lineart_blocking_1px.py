...
def hero_part_masks() -> dict[str, list[list[int]]]:
    return {
        "back_leg": raster(
            polygons=[
...
def thug_part_masks() -> dict[str, list[list[int]]]:
    return {
        "left_leg": raster(
            polygons=[
...
def build_hero() -> list[list[int]]:
    ...
    p = hero_part_masks()
    back_leg = p["back_leg"]
    back_boot = p["back_boot"]
    torso = p["torso"]
    neck = p["neck"]
    head_skin = p["head_skin"]
    hair = p["hair"]
    front_leg = p["front_leg"]
    front_boot = p["front_boot"]
    vest_l = p["vest_l"]
    vest_r = p["vest_r"]
    bra = p["bra"]
    low_arm = p["low_arm"]
...
def build_thug() -> list[list[int]]:
    ...
    p = thug_part_masks()
    left_leg = p["left_leg"]
    left_boot = p["left_boot"]
    right_leg = p["right_leg"]
    right_boot = p["right_boot"]
    shorts = p["shorts"]
    torso = p["torso"]
    neck = p["neck"]
    head_skin = p["head_skin"]
