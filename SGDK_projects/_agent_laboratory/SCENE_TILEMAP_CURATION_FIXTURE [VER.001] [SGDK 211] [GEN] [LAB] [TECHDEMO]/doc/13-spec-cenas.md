# 13 - Especificacao Tecnica por Cena - SCENE_TILEMAP_CURATION_FIXTURE
...
### Cena 4 - `tilemap_fixture_320x224_v001`

- nome de trabalho: `tilemap_fixture_320x224_v001`
- runtime_name na ROM: `APP_SCENE_TILEMAP_FIXTURE`
- `app_scene_id`: `4`
- papel: fixture lab de conversao de cena para tileset/tilemap com auditoria de dedup e flip
- objetivo: provar reports canonicos em `out/logs` para dedup/HV flip e conflitos de sub-paleta, antes de qualquer promocao de tecnica
