...
#include "scenes/scene_tilemap_fixture.h"
...
const char* APP_sceneName(AppScene scene)
{
    switch (scene)
    {
        ...
        case APP_SCENE_TILEMAP_FIXTURE: return "TILEMAP";
...
void APP_update(void)
{
    ...
    if (gApp.sceneNeedsEnter)
    {
        switch (gApp.currentScene)
        {
            ...
            case APP_SCENE_TILEMAP_FIXTURE: SCENE_tilemapFixtureEnter(); break;
    ...
    switch (gApp.currentScene)
    {
        ...
        case APP_SCENE_TILEMAP_FIXTURE: SCENE_tilemapFixtureUpdate(); break;
