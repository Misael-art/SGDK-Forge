...
| 2026-06-13 | `promotion_candidate` | art_gameplay_direction_gate | Impede gerar model sheet, background, sprite art ou sprite sheet critico sem supervisao de art director + game design, GDD/spec, camera, interacao, marcadores de identidade e movimento/carismo. | doc/contracts/art_gameplay_direction_gate_v009.json + doc/contracts/human_validation_record_v009.md | alto | promovido para schema, skills, workflows e pipelines por diretiva humana |
