...
- `project_hygiene` e validacao metodologica base obrigatoria. Mudanca de implementacao ou arquitetura torna `doc/10-memory-bank.md` e `doc/changelog/changelog.md` obrigatoriamente atualizaveis; deriva gera `project_documentation_sync_stale`.
