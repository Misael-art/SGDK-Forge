...
description: Pipeline completo de conversao de assets visuais para o padrao SGDK / Mega Drive. Cobre: quantizacao de paleta, redimensionamento para grid 8x8, indexacao, correcao de transparencia, geracao de spec JSON, uso do photo2sgdk e batch_resize_index.py. Garante assets equiparaveis aos melhores jogos comerciais do Mega Drive.
---
