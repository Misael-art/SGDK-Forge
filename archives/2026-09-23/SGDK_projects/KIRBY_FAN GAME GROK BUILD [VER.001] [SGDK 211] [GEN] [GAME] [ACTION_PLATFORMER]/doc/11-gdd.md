# 11 - Game Design Document — KIRBY_FAN GAME GROK BUILD [VER.001] [SGDK 211] [GEN] [GAME] [ACTION_PLATFORMER]

## Project Brief

- [qual e a promessa central do jogo]
- [o que o jogador faz]
- [o que torna esta proposta digna do Mega Drive]
- [o que o projeto explicitamente nao e]

## Visao

[Descricao em 1-2 paragrafos do que o jogo e e o que nao e.]

## Core Loop

- [acao principal -> feedback -> risco -> recompensa]
- [o que o jogador repete nos primeiros 30 segundos]
...
- [feature futura, mas aprovada para backlog]
...
- [qual fantasia o menu/title screen deve comunicar no primeiro frame]
- [qual linguagem visual combina com o projeto: sci-fi, fantasia, urbano, industrial, natural, etc.]
- [qual eixo visual vivo sera usado em idle: parallax, cycling, wobble, timeline curta ou equivalente]
- [como a selecao deve dar feedback ativo]
- [o que seria visualmente fora de tom para este projeto]

## Ambicao Tecnica, Visual e Sonora

- `quality_promise`: [qual barra de qualidade este jogo precisa superar e como isso sera percebido]
- `visual_direction`: [sprites, cenarios, cores, animacao, leitura e exuberancia pretendidas]
- `sound_direction`: [identidade musical, papel dos SFX, dinamica e momentos marcantes]
- `gameplay_quality_bar`: [fluidez, resposta, legibilidade, profundidade e variedade exigidas]
- `hardware_strategy`: [como o Mega Drive sera usado com excelencia sem prometer recursos inexistentes]
...
|---|---|---|---|---|---|---|---|
| [scene_id] | [registry_id] | [TAG] | [decisao/risco/leitura/ritmo] | [resultado perceptivo] | [skill] | [report/captura] | [recuo honesto] |

### Tecnicas rejeitadas ou adiadas

| Registry id | Decisao | Motivo | Condicao para reconsiderar |
|---|---|---|---|
| [registry_id] | [rejeitada/adiada] | [incompativel, sem funcao ou sem budget] | [evidencia/escopo necessario] |
...
- [como o jogador avanca]
- [estrutura de niveis/fases]
...
- [qual e a primeira entrega jogavel]
