...
- Art/game design direction gate: `doc/contracts/art_gameplay_direction_gate_v009.json`.
...
- The production also failed the supervision chain: sprite sheet generation was not sufficiently constrained by art director review, GDD/spec context, camera perspective, interaction context, identity markers and motion/personality requirements before asset production.
