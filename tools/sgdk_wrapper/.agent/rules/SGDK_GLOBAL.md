...
- Para qualquer arte candidata a producao, a avaliacao deve seguir `tools/sgdk_wrapper/.agent/references/production_visual_quality_contract.md`: melhoria relativa a placeholder, build verde ou screenshot nao e qualidade. Projeto com prancha local de referencia deve usa-la como baseline de oficio, sem copiar os pixels.
