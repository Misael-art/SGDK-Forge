...
- `camera_behavior_contract` quando houver scroll jogavel, camera trigger, boss room, chase, screen shake ou culling por viewport
...
- ownership unico de camera, scroll manager, triggers, shake e culling quando houver `camera_behavior_contract`
...
- quando houver camera jogavel, `camera_behavior_contract` nao deixa deadzone, lookahead, clamp, trigger, shake, culling, owner ou reset implicitos
...
- se houver `camera_behavior_contract`, quem possui deadzone, lookahead, clamp, triggers, shake, culling e reset?
...
- criar segundo camera manager, segundo sistema de culling por viewport ou triggers paralelos fora do owner da cena
...
- `camera behavior ownership`
  - deadzone, smoothing, lookahead, clamp, trigger zones, screen shake, culling e snap inteiro final com owner unico e reset simetrico
