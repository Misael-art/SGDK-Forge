...
description: Use apenas quando o projeto estiver sem arte utilizavel e o usuario precisar decidir entre gerar assets com IA ou buscar assets livres na web antes da conversao para SGDK. Nao use quando ja existir arte em /data ou /res, quando o trabalho for apenas converter assets existentes, quando a tarefa for auditoria estetica de qualidade, ou quando ja existe uma imagem-fonte forte e o proximo passo real e a traducao para VDP; nesse caso use `art-translation-to-vdp`.
---
