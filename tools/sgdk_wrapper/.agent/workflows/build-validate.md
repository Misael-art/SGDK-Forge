...
9. Capturar evidencia de runtime:
   ...
   - quando o projeto emitir bloco de evidencia visual em SRAM, aceitar `screenshot + save.sram + visual_vdp_dump.bin` como prova minima suficiente; quicksave nativo vira redundancia opcional
