...
BEGIN = "<!-- BEGIN: diretriz-bloqueio-estetico v5 -->"
END = "<!-- END: diretriz-bloqueio-estetico v5 -->"
# v1 fica reconhecido para que o bloco antigo seja substituido, nao duplicado.
LEGACY_MARKERS = [
    ("<!-- BEGIN: diretriz-bloqueio-estetico v4 -->", "<!-- END: diretriz-bloqueio-estetico v4 -->"),
