...
Voce vai atuar **somente** em `tools/sgdk_wrapper` do workspace ativo para implementar novas capacidades no ecossistema de agentes e automacao SGDK.

## Missao

Implemente, com seguranca e sem regressao, a expansao do ecossistema AAA descrita nos documentos abaixo:

- `tools/sgdk_wrapper/doc/aaa_agent_feature_roadmap.md`
- `tools/sgdk_wrapper/doc/aaa_agent_feature_implementation_spec.md`
- `tools/sgdk_wrapper/doc/aaa_agent_feature_handoff_checklist.md`
