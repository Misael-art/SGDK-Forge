...
**Data:** 2026-04-21  
**Alvo:** `tools/sgdk_wrapper` do workspace ativo  
...
- `out/evidence/blastem/visual_vdp_dump.bin` apenas quando houver exportador legado compativel
...
- o bundle canonico atual para projetos V2 e `screenshot + save.sram`
- `save.sram` com assinatura `MDRT` substitui a dependencia antiga de `visual_vdp_dump.bin`
- `visual_vdp_dump.bin` permanece documentado como recurso historico legado
