...
endlocal & set "SGDK_ENTRY_DIR=%SGDK_ENTRY_DIR%" & set "SGDK_PROJECT_ROOT=%SGDK_PROJECT_ROOT%" & set "SGDK_WORK_DIR=%SGDK_WORK_DIR%" & set "SGDK_LAYOUT=%SGDK_LAYOUT%" & set "SGDK_MANIFEST_PATH=%SGDK_MANIFEST_PATH%" & set "SGDK_DISPLAY_NAME=%SGDK_DISPLAY_NAME%" & set "SGDK_KIND=%SGDK_KIND%" & set "SGDK_CATEGORY=%SGDK_CATEGORY%" & set "SGDK_BUILD_POLICY=%SGDK_BUILD_POLICY%" & set "SGDK_NOTES=%SGDK_NOTES%" & set "SGDK_RESOLUTION_REASON=%SGDK_RESOLUTION_REASON%" & set "SGDK_ENTRY_DIR_SHORT=%SGDK_ENTRY_DIR_SHORT%" & set "SGDK_PROJECT_ROOT_SHORT=%SGDK_PROJECT_ROOT_SHORT%" & set "SGDK_WORK_DIR_SHORT=%SGDK_WORK_DIR_SHORT%"
