...
- necessidade confirmada que excede XGM2 padrao
- alvo de sample rate, formato, canais e latencia aceitavel
- mapa de memoria Z80/ROM e protocolo 68K-Z80 pretendido
- budget de DMA/VDP que possa pausar o Z80
...
- driver, buffers e tabelas cabem em 8KB de Z80 RAM
...
- entregar `integration_contract` para `xgm2-audio-director`
- entregar inicializacao, callbacks e cleanup para `sgdk-runtime-coder`
- entregar janelas de DMA e riscos de starvation para `megadrive-vdp-budget-analyst`
