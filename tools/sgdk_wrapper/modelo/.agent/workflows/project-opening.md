...
- classificar `doc/agent_learning/` com `workflows/project-learning-loop.md` sem bloquear projeto legado quando o contexto estiver ausente
...
O local padrao para o registro passivo e `doc/agent_learning/`, seguindo `workflows/project-learning-loop.md`.
