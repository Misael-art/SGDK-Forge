...
2. Renomeie o diretorio conforme o documento do workspace `doc/PADRAO_NOMENCLATURA.md` e substitua `__PROJECT_NAME__` nos documentos e em [`.mddev/project.json`](./.mddev/project.json).
